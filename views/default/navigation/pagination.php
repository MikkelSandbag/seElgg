...
if ($current_page > 1) {
	...
	$pages->prev ['href'] = elgg_http_add_url_query_elements ( $base_url, array (
			$offset_key => $prev_offset 
	) );
...
if ($current_page < $total_pages) {
	...
	$pages->next ['href'] = elgg_http_add_url_query_elements ( $base_url, array (
...
foreach ( $pages->items as $page ) {
	if ($page == $current_page) {
		...
		$url = elgg_http_add_url_query_elements ( $base_url, array (
