...
.elgg-pagination a:hover, .elgg-pagination a:focus {
	background: #4690d6;
	color: white;
...
.elgg-menu-topbar>li>a:hover, .elgg-menu-topbar>li>a:focus {
	color: #4690D6;
	text-decoration: none;
}
...
.elgg-menu-hover a:hover, .elgg-menu-hover a:focus {
	background: #ccc;
	text-decoration: none;
}
...
.elgg-menu-hover-admin a:hover, .elgg-menu-hover-admin a:focus {
	color: white;
