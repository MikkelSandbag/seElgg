...
<?
php?> // force vertical scroll bar ?>  html, body {
	height: 100%;
	margin-bottom: 1px;
}
...
.elgg-menu-user, .elgg-menu-admin-header {
	float: right;
	margin: 8px 8px 0 0;
}

.elgg-menu-user, .elgg-menu-admin-header, .elgg-menu-user a,
	.elgg-menu-admin-header a {
	color: #999999;
}

.elgg-menu-user a, .elgg-menu-admin-header a {
	text-decoration: underline;
}
...
.elgg-menu-user li, .elgg-menu-admin-header li {
	display: inline;
}

.elgg-menu-user li:after, .elgg-menu-admin-header li:after {
	content: "|";
...
.elgg-menu-user li:last-child:after, .elgg-menu-admin-header li:last-child:after
	{
	content: "";
}
...
label.elgg-state-disabled, input.elgg-state-disabled {
	opacity: 0.6;
}
...
.elgg-input-text, .elgg-input-tags, .elgg-input-url,
	.elgg-input-plaintext, .elgg-input-longtext {
	width: 98%;
}
...
.elgg-button-submit.elgg-state-disabled, .elgg-button-action.elgg-state-disabled
	{
	color: #999;
	cursor: default;
}
...
.elgg-form-useradd input[type=text], .elgg-form-useradd input[type=password]
	{
	width: 300px;
}
...
<?
php?>
 // autocomplete will expand to fullscreen without max-width ?> 	.ui-autocomplete {
	position: absolute;
	cursor: default;
}
...
.friends-picker-navigation-l {
	background:
		url("<?php echo elgg_get_site_url(); ?>_graphics/friendspicker.png")
		no-repeat left top;
}
...
/* ***************************************
	GENERAL MENU
*************************************** */
.elgg-menu-general>li, .elgg-menu-general>li>a {
	display: inline-block;
	color: #999;
}
...
*************************************** */
<?
php?> // height depends on line height /font size ?>  .elgg-menu-entity,
...
<?
php?> // need to override .elgg-menu-hz ?>  .elgg-menu-entity>li>a,
...
a.elgg-widget-collapse-button:hover, a.elgg-widget-collapsed:hover {
	color: #9d9d9d;
	text-decoration: none;
}
...
.elgg-icon {
	...
	_graphics /admin_sprites.png) no-repeat left;
	width: 16px;
	height: 16px;
	display: inline-block;
	margin: 0 2px;
...
.elgg-icon-delete:hover, .elgg-icon-delete-alt:hover {
	background-position: 0 -0px;
}

.elgg-icon-delete, .elgg-icon-delete-alt {
...
.elgg-plugin-contributors dl, .elgg-plugin-contributors dd {
	display: inline;
	padding-right: 5px
}
...
ul.elgg-plugin-categories, ul.elgg-plugin-categories>li, ul.elgg-plugin-resources,
	ul.elgg-plugin-resources>li {
	display: inline;
}
...
.elgg-markdown h1, .elgg-markdown h2, .elgg-markdown h3, .elgg-markdown h4,
	.elgg-markdown h5, .elgg-markdown h6 {
...
.elgg-transition:hover, .elgg-transition:focus, :focus>.elgg-transition
	{
	opacity: .7;
}
