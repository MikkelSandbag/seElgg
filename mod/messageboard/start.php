...
function messageboard_init() {
	...
	elgg_register_widget_type ( 'messageboard', elgg_echo ( "messageboard:board" ), elgg_echo ( "messageboard:desc" ), array (
			"profile" 
	) );
 ...
 *
 * @param ElggUser $poster
 *        	User posting the message
 * @param ElggUser $owner
 *        	User who owns the message board
 * @param string $message
 *        	The posted message
 * @param int $access_id
 *        	Access level (see defines in elgglib.php)
 * @return bool
 */
