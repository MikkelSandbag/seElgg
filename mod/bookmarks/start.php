...
function bookmarks_init() {
	...
	elgg_register_notification_event ( 'object', 'bookmarks', array (
			'create' 
	) );
...
function bookmarks_prepare_notification($hook, $type, $notification, $params) {
	...
	$notification->subject = elgg_echo ( 'bookmarks:notify:subject', array (
			$title 
	), $language );
	...
	$notification->summary = elgg_echo ( 'bookmarks:notify:summary', array (
			$entity->title 
	), $language );
