...
<table class="theme-sandbox-table mtl">
	...
	<tbody>
		<tr>
			...
			<td><input type="submit" class="elgg-button elgg-state-disabled"
				value="submit" /></td>
		</tr>
		<tr>
			<th>Action (.elgg-button-action)</th>
			<td><input type="submit" class="elgg-button elgg-button-action"
				value="submit" /></td>
		...
		<tr>
			<th>Cancel (.elgg-button-cancel)</th>
			<td><input type="submit" class="elgg-button elgg-button-cancel"
				value="submit" /></td>
			<td><input type="submit"
		...
		<tr>
			<th>Submit (.elgg-button-submit)</th>
			<td><input type="submit" class="elgg-button elgg-button-submit"
				value="submit" /></td>
			<td><input type="submit"
		...
		<tr>
			<th>Special (.elgg-button-special)</th>
			<td><input type="submit" class="elgg-button elgg-button-special"
				value="submit" /></td>
			<td><input type="submit"
		...
		<tr>
			<th>Delete (.elgg-button-delete)</th>
			<td><input type="submit" class="elgg-button elgg-button-delete"
				value="submit" /></td>
			<td><input type="submit"
