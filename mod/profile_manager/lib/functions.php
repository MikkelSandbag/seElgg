 ...
 *        	Name of the register where the fields are configured
 ...
 *
 * @param string $register_name
 *        	Name of the register to retrieve
 *        	
 * @return false|array
 */
 ...
 *
 * @param ElggUser $user
 *        	The user to add the profile icons to
 *        	
 * @return boolean
 */
 ...
 *        	User to check
 * @param boolean $edit
 *        	Are you editing profile fields
 * @param boolean $register
 *        	Are you on the register page
 * @param boolean $profile_type_limit
 *        	Should it be limited by the profile type
 * @param int $profile_type_guid
 *        	The guid of the profile type to limit the results to
 *        	
 * @return unknown
 */
 ...
 *        	Group to check the values of the fields against
 *        	
 * @return array
 */
 ...
 *
 * @param ElggUser $user
 *        	User to count completeness for
 *        	
 ...
 *
 * @param stdClass $row
 *        	Row returned from an elgg_get_entities* function
 *        	
 * @return string
 */
