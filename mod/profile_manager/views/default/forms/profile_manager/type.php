...
$formbody .= elgg_view ( 'input/text', array (
		'name' => 'metadata_name',
		"value" => $metadata_name 
) );
...
$formbody .= elgg_view ( 'input/longtext', array (
...
if (! empty ( $categories )) {
	...
	$formbody .= elgg_view ( "input/checkboxes", array (
			"name" => "categories",
...
?>
<div class="elgg-module elgg-module-inline mvn"
