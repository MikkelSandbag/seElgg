...
$form_body .= elgg_view ( "input/pm_user_summary_selector", array (
		"id" => "profile-manager-user-summary-config-options" 
) );
;
...
$body = elgg_view ( "input/form", array (
		"body" => $form_body,
		"action" => "action/profile_manager/user_summary_control/save" 
) );
