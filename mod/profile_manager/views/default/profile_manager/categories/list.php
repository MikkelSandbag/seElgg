	...
	<div class="elgg-body" id="custom_fields_category_list_custom">
		<div id="custom_profile_field_category_all"
			...
			<a href="javascript:void(0);"
				onclick="elgg.profile_manager.filter_custom_fields();"><?php echo elgg_echo("all"); ?></a>
		</div>
		<div id="custom_profile_field_category_0"
			class="custom_fields_category">
			<a href="javascript:void(0);"
				onclick="elgg.profile_manager.filter_custom_fields(0);"><?php echo elgg_echo("profile_manager:categories:list:default"); ?></a>
		</div>
		<?php echo $list; ?>
	</div>
</div>
