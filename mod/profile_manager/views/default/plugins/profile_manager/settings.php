...
echo elgg_view ( "profile_manager/admin/tabs", array (
...
<table>
	...
	<tr>
		...
		<td>
			<?php
			$edit_profile_mode_options = array (
			...
			echo elgg_view ( "input/dropdown", array (
					...
					"value" => $vars ['entity']->edit_profile_mode 
			) );
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			$profile_type_selection_options = array (
			...
			echo elgg_view ( "input/dropdown", array (
					...
					"value" => $vars ['entity']->profile_type_selection 
			) );
			?>
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<?php
			$display_categories_options = array (
			...
			echo elgg_view ( "input/dropdown", array (
					...
					"value" => $vars ['entity']->display_categories 
			) );
			?>
		</td>
	</tr>
