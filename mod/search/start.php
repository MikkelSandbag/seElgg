 ...
 *
 * @param array $page
 *        	Page elements from core page handler
 * @return bool
 */
 ...
 * @param string $query        	
 * @param int $min_match_context
 *        	= 30
 * @param int $max_length
 *        	= 300
 * @param bool $tag_match
 *        	Search is for tags. Don't ignore words.
 * @return string
 */
 ...
 *
 * @param str $entities_table
 *        	Prefix for entities table.
 * @param str $type_table
 *        	Prefix for the type table.
 * @param str $sort
 *        	ORDER BY part
 * @param str $order
 *        	ASC or DESC
 ...
 *        	Hook type
 * @param string $text
 *        	robots.txt content for plugins
 * @return string
 */
