 ...
 *        	URL of the endpoint.
 * @param array $call
 *        	Associated array of "variable" => "value"
 * @param string $method
 *        	GET or POST
...
function send_api_call(array $keys, $url, array $call, $method = 'GET', $post_data = '', $content_type = 'application/octet-stream') {
	...
	switch (strtoupper ( $method )) {
		...
		case 'POST' :
			break;
		default :
			$msg = elgg_echo ( 'NotImplementedException:CallMethodNotImplemented', array (
					$method 
			) );
 ...
 *        	Associated array of "variable" => "value"
 * @param array $keys
 *        	The keys dependant on chosen authentication method
 *        	
 * @return string
 */
 ...
 *
 * @param array $headers
 *        	The array of headers "key" => "value"
 *        	
 * @return string
 * @access private
 */
