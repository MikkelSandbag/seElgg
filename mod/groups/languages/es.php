...
return array (
		...
		'groups:owner:warning' => "Advertencia: si cambia este valor, usted ya no es el dueño de este grupo.",
		...
		'discussion:topic:notify:body' => '%s ha agregado un nuevo tema al grupo %s:
...
',
		...
		'discussion:reply:notify:body' => '%s ha respondido al tema %s en el grupo %s:
