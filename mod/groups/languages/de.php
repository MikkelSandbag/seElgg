...
return array (
		...
		'discussion:topic:notify:body' => '%s hat einen neuen Gruppen-Diskussionsbeitrag in der Gruppe %s erstellt:
...
',
		...
		'discussion:reply:notify:body' => '%s hat auf den Diskusstionsbeitrag %s in der Gruppe %s geantwortet:
