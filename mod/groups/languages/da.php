...
return array (
		...
		'discussion:topic:notify:body' => '%s har tilføjet et nyt diskussionsemne i gruppen %s:
...
',
		...
		'discussion:reply:notify:body' => '%s replied to the discussion topic %s in the group %s:
