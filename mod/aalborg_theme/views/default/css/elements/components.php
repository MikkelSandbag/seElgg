...
<?
php?> // @todo components.php ?>  .elgg-river-responses {
	margin-top: 15px;
}
...
<?
php?> // @todo location-dependent styles ?>  .elgg-river-item form {
	border-color: #DCDCDC;
	border-style: solid;
	border-width: 0 1px 1px 1px;
	padding: 6px;
...
/* **************************************
	Comments triangle
************************************** */
.elgg-comments .elgg-list:after, .elgg-comments .elgg-list:before,
	.elgg-river-comments:after, .elgg-river-comments:before {
	bottom: 100%;
	left: 30px;
...
.elgg-comments .elgg-list:after, .elgg-river-comments:after {
