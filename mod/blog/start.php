...
function blog_init() {
	...
	// notifications
	elgg_register_notification_event ( 'object', 'blog', array (
			'publish' 
	) );
...
function blog_page_handler($page) {
	...
	if (isset ( $params ['sidebar'] )) {
		$params ['sidebar'] .= elgg_view ( 'blog/sidebar', array (
				'page' => $page_type 
		) );
	} else {
		$params ['sidebar'] = elgg_view ( 'blog/sidebar', array (
...
function blog_prepare_notification($hook, $type, $notification, $params) {
	...
	$notification->subject = elgg_echo ( 'blog:notify:subject', array (
			$entity->title 
	), $language );
	...
	$notification->summary = elgg_echo ( 'blog:notify:summary', array (
			$entity->title 
	), $language );
