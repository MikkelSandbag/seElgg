...
class TidypicsAlbum extends ElggObject {
	 ...
	 *
	 * @param array $options
	 *        	Options to pass to elgg_view_entity_list()
	 * @return string
	 */
	 ...
	 *
	 * @param array $list
	 *        	An indexed array of image guids
	 * @return bool
	 */
	 ...
	 * Wraps around to the last image if given the first.
	 *
	 * @param int $guid
	 *        	GUID of the current image
	 * @return TidypicsImage
	 */
	 ...
	 * Wraps around to the first image if given the last.
	 *
	 * @param int $guid
	 *        	GUID of the current image
	 * @return TidypicsImage
