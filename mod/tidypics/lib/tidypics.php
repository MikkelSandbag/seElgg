 ...
 * @param
 *        	array (optional) array of owner guids
 * @param
 *        	string (optional) context of view to display
 ...
 * @param
 *        	array (optional) array of container_guids
 * @param
 *        	string (optional) context of view to display
 * @return string of html for display
 */
 ...
 *
 * @return string to image directory
 */
...
/**
 * Returns just a guid from a database $row.
 * Used in elgg_get_entities()'s callback.
 *
 * @param stdClass $row        	
 * @return type
 */
