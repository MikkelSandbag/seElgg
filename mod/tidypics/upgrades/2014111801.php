...
$batch = new ElggBatch ( 'elgg_get_river', array (
		...
		'action_type' => 'comment',
		'joins' => array (
				"JOIN {$db_prefix}entities im ON im.guid = rv.target_guid" 
		),
		'wheres' => array (
				"im.subtype = $image_subtype_id" 
		),
		'limit' => false 
) );
...
$batch = new ElggBatch ( 'elgg_get_river', array (
		...
		'action_type' => 'comment',
		'joins' => array (
				"JOIN {$db_prefix}entities al ON al.guid = rv.target_guid" 
		),
		'wheres' => array (
				"al.subtype = $album_subtype_id" 
		),
		'limit' => false 
) );
...
$batch = new ElggBatch ( 'elgg_get_river', array (
		...
		'action_type' => 'comment',
		'joins' => array (
				"JOIN {$db_prefix}entities ba ON ba.guid = rv.target_guid" 
		),
		'wheres' => array (
				"ba.subtype = $tidypics_batch_subtype_id" 
		),
		'limit' => false 
) );
...
$batch = new ElggBatch ( 'elgg_get_entities', array (
		...
		'subtype' => 'comment',
		'joins' => array (
				"JOIN {$db_prefix}entities ba ON ba.guid = e.container_guid" 
		),
		'wheres' => array (
				"ba.subtype = $tidypics_batch_subtype_id" 
		),
...
$batch = new ElggBatch ( 'elgg_get_entities', array (
		...
		'subtype' => 'comment',
		'joins' => array (
				"JOIN {$db_prefix}entities al ON al.guid = e.container_guid" 
		),
		'wheres' => array (
				"al.subtype = $album_subtype_id" 
		),
...
$batch = new ElggBatch ( 'elgg_get_annotations', array (
		...
		'joins' => array (
				"JOIN {$db_prefix}entities li ON li.guid = n_table.entity_guid" 
		),
		'wheres' => array (
				"li.subtype = $tidypics_batch_subtype_id" 
		),
		'limit' => false 
) );
