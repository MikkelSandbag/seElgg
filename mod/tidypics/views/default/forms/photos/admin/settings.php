...
$content = elgg_view ( 'forms/photos/admin/settings/main', array (
		'plugin' => $plugin 
) );
echo elgg_view_module ( 'inline', $title, $content );

$title = elgg_echo ( 'tidypics:settings:heading:img_lib' );
$content = elgg_view ( 'forms/photos/admin/settings/image_lib', array (
		'plugin' => $plugin 
) );
echo elgg_view_module ( 'inline', $title, $content );

$title = elgg_echo ( 'tidypics:settings:heading:river' );
$content = elgg_view ( 'forms/photos/admin/settings/activity', array (
		'plugin' => $plugin 
) );
echo elgg_view_module ( 'inline', $title, $content );

$title = elgg_echo ( 'tidypics:settings:heading:sizes' );
$content = elgg_view ( 'forms/photos/admin/settings/thumbnails', array (
		'plugin' => $plugin 
) );
echo elgg_view_module ( 'inline', $title, $content );
