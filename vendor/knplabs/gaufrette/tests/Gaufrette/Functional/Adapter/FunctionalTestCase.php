...
abstract class FunctionalTestCase extends \PHPUnit_Framework_TestCase {
	...
	public function getAdapterName() {
		if (! preg_match ( '/\\\\(\w+)Test$/', get_class ( $this ), $matches )) {
			throw new \RuntimeException ( sprintf ( 'Unable to guess filesystem name from class "%s", ' . 'please override the ->getAdapterName() method.', get_class ( $this ) ) );
		}
	...
	public function setUp() {
		...
		$filename = sprintf ( '%s/adapters/%s.php', dirname ( __DIR__ ), $basename );
