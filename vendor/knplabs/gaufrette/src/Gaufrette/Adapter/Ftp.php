 ...
 */
class Ftp implements Adapter, FileFactory, ListKeysAware {
	 ...
	 *        	The directory to use in the ftp server
	 * @param string $host
	 *        	The host of the ftp server
	 * @param array $options
	 *        	The options like port, username, password, passive, create, mode
	 */
	 ...
	 *
	 * @param string $directory
	 *        	The path of the directory to list from
	 *        	
	 ...
	 * If it does not, and the create
	 * parameter is set to TRUE, it tries to create it
	 *
	 * @param string $directory        	
	 * @param boolean $create
	 *        	Whether to create the directory if it does not
	 *        	exist
	 *        	
	...
	/**
	 * Returns an opened ftp connection resource.
