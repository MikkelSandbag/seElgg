...
class File {
	...
	/**
	 * Content variable is lazy.
	 * It will not be read from filesystem until it's requested first time
	 * 
	 * @var mixed content
	 */
	 ...
	 *        	optional metadata which should be send when read
	 * @return string
	 */
	 ...
	 * @param array $metadata
	 *        	optional metadata which should be send when write
	 *        	
