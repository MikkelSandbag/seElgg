...
abstract class AbstractDriverTest extends \PHPUnit_Framework_TestCase {
	...
	public function testClear($driver) {
		...
		$this->assertTrue ( $driver->clear ( array (
				'base' 
		) ), 'clear of base node returned true' );
		
		foreach ( $this->data as $type => $value ) {
			$this->assertFalse ( $driver->getData ( array (
					'base',
					$type 
			) ), 'clear of base node removed data' );
		}
		...
		foreach ( $this->data as $type => $value ) {
			$this->assertFalse ( $driver->getData ( array (
					'base',
					$type 
			) ), 'clear of root node removed data' );
		}
