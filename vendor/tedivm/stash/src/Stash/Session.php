...
class Session implements SessionHandlerInterface {
	 ...
	 * session.
	 * Basically all persistence is handled by this object.
	 *
	 * @var Stash\Pool
	 */
	protected $pool;
	 ...
	 * systems.
	 * This class uses it as a namespace instead.
	 *
	 * @var string
	 */
	...
	public static function registerHandler(Session $handler) {
		...
		if (version_compare ( PHP_VERSION, '5.4.0' ) >= 0) {
			...
			$results = session_set_save_handler ( array (
					$handler,
					'open' 
			), array (
					$handler,
	...
	/**
	 * The constructor expects an initialized Pool object.
	...
	/**
	 * Options can be set using an associative array.
	 ...
	 * internal use.
	 * It takes the saved session path and turns it into a
	 * namespace.
	 *
	 ...
	 * This function is defined by the SessionHandlerInterface and is for PHP's
	 * internal use.
	 * It reads the session data from the caching system.
	 *
	 ...
	 * This function is defined by the SessionHandlerInterface and is for PHP's
	 * internal use.
	 * It writes the session data to the caching system.
	 *
	 * @param string $session_id        	
	 ...
	 * This function is defined by the SessionHandlerInterface and is for PHP's
	 * internal use.
	 * It currently does nothing important, as there is no need to
	 * take special action.
	 *
	 * @return bool
	 */
	 ...
	 * This function is defined by the SessionHandlerInterface and is for PHP's
	 * internal use.
	 * It is called randomly based on the session.gc_divisor,
