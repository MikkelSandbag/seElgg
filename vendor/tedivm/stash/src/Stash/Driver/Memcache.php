...
/**
 * Memcache is a wrapper around the popular memcache server.
 * Memcache supports both memcache php
...
class Memcache implements DriverInterface {
	 ...
	 * This includes running the indexing functions used to manage the memcached
