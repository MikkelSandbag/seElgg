...
/**
 * The Redis driver is used for storing data on a Redis system.
 * This class uses
...
class Redis implements DriverInterface {
	...
	public function setOptions(array $options = array()) {
		...
		if (isset ( $options ['servers'] )) {
			$unprocessedServers = (is_array ( $options ['servers'] )) ? $options ['servers'] : array (
					$options ['servers'] 
			);
	 ...
	 * This includes running the indexing functions used to manage the Redis
