 ...
 * persistence limitations to be backed up by slower but larger and more persistent caches.
...
class Composite implements DriverInterface {
	...
	/**
	 * This starts with the first driver and keeps trying subsequent drivers until a result is found.
	 * It then fills
	...
	public function storeData($key, $data, $expiration) {
		return $this->actOnAll ( 'storeData', array (
				$key,
				$data,
				$expiration 
		) );
	...
	public function clear($key = null) {
		return $this->actOnAll ( 'clear', array (
				$key 
		) );
	}
	...
	/**
	 * This function checks to see if this driver is available.
	 * This always returns true because this
