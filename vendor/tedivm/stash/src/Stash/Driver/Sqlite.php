...
/**
 * StashSqlite is a wrapper around one or more SQLite databases stored on the local system.
 * While not as quick at at
...
class Sqlite implements DriverInterface {
	...
	protected function checkStatus() {
		...
		$driver = $this->getSqliteDriver ( array (
				'_none' 
		) );
	...
	/**
	 * This function takes an array of strings and turns it into the sqlKey.
	 * It does this by iterating through the
