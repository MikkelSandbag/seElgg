 ...
 * as performance intensive as including a file.
 * Since the data is stored as php this module can see performance
...
class FileSystem implements DriverInterface {
	/**
	 * This is the path to the file which will be used to store the cached item.
	 * It is based off of the key.
	 *
	 * @var string
	 */
	protected $path;
	 ...
	 * calculated each time the driver is called.
	 * This only stores path information, it does not store the data to be
	 * cached.
	 *
	 * @var array
	 */
	...
	/**
	 * This is the base path for the cache items to be saved in.
	 * This defaults to a directory in the tmp directory (as
	...
	/**
	 * The level of directories each key will have.
	 * This is used to reduce the number of files or directories
	...
	/**
	 * The hashing algorithm used to normalize keys into filesystem safe values.
	 * The only reason this gets changed is
	 ...
	 * If the file does not exist, or is currently being written to, it
	...
	/**
	 * This function takes the data and stores it to the path specified.
	 * If the directory leading up to the path does
	 ...
	 *
	 * @param array $key
	 *        	Null arguments return the base directory.
	...
	/**
	 * This function clears the data from a key.
	 * If a key points to both a directory and a file, both are erased. If
	 ...
	 * This returns true no matter what, since
