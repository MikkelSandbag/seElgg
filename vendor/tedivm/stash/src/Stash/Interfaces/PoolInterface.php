...
interface PoolInterface {
	 ...
	 * from storage.
	 * Not all drivers need this, as many interact with systems that handle them automatically.
	 *
	...
	/**
	 * Sets the driver for use by the caching system.
	 * This driver handles the direct interfaceion with the caching
	...
	/**
	 * Places the Pool inside of a "namespace".
	 * All Items inside a specific namespace should be completely segmented
