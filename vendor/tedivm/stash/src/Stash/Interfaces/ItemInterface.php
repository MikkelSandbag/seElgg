...
interface ItemInterface {
	 ...
	 * This is particularly useful when the Item is
	 ...
	 * If hierarchical or "stackable" caching is being
	...
	/**
	 * Returns the data retrieved from the cache.
	 * Since this can return false or
	...
	/**
	 * Takes and stores data for later retrieval.
	 * This data can be any php data,
	 ...
	 *        	Int is time (seconds), DateTime a future expiration date
	 * @return bool Returns whether the object was successfully stored or not.
	 */
	public function set($data, $ttl = null);
	
	/**
	 * Extends the expiration on the current cached item.
	 * For some engines this
