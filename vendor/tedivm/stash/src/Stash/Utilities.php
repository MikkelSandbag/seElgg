...
class Utilities {
	/**
	 * Various drivers use this to define what kind of encoding to use on objects being cached.
	...
	/**
	 * Uses the encoding function to define an encoding and uses it on the data.
	...
	/**
	 * Returns the default base directory for the system when one isn't provided by the developer.
	 * This is a directory
	 ...
	 * @param bool $cleanParent
	 *        	Whether to prune empty parent directories or not.
