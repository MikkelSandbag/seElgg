 ...
 * connection.
 * This class can store any native php datatype, as long as it can be serialized (so when creating classes
...
class Item implements ItemInterface {
	 ...
	 * It is used internally when the storage engine fails or if the cache is being
	...
	/**
	 * Used internally to mark the class as disabled.
	 * Unlike the static runtimeDisable flag this is effective only for
	...
	protected $defaults = array (
			'precompute_time' => 40, // time, in seconds, before expiration
...
;
	...
	/**
	 * The identifier for the item being cached.
	 * It is set through the setupKey function.
	 *
	...
	/**
	 * The cacheDriver being used by the system.
	 * While this class handles all of the higher functions, it's the cache
	...
	/**
	 * If set various then errors and exceptions will get passed to the PSR Compliant logging library.
	 * This
	 ...
	 * It is set by the getData function and is used by the
	 * isMiss function.
	 *
	 * @var bool
	 */
	...
	/**
	 * Decides whether the current data is fresh according to the supplied validation technique.
	 * As some techniques
	...
	/**
	 * This function is used by the Pool object while creating this object.
	 * It
