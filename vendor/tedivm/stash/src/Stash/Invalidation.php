...
/**
 * Contains a grouping of invalidation flags.
 * These are passed to the Item
...
class Invalidation {
	 ...
	 * isMiss will return false while another Item is being
	 * populated.
	 */
	const OLD = 1;
	 ...
	 * it actually expires.
	 * While one item is regenerating the rest are still using the cached data as it is still good.
	 */
	const PRECOMPUTE = 4;
}
