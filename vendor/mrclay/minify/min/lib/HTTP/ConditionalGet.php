...
class HTTP_ConditionalGet {
	 ...
	 * Send headers
	 *
	 * @see getHeaders() Note this doesn't "clear" the headers. Calling sendHeaders() will
	 ...
	 *        	if given, both ETag AND Last-Modified headers
	 *        	will be sent with content. This is recommended.
	 *        	
	 * @param bool $isPublic
	 *        	(default false) if true, the Cache-Control header
	 *        	will contain "public", allowing proxies to cache the content. Otherwise
	 *        	"private" will be sent, allowing only browser caching.
	 *        	
	 * @param array $options
	 *        	(default empty) additional options for constructor
	 */
