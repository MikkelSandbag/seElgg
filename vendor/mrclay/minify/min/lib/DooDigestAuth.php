...
class DooDigestAuth {
	 ...
	 *
	 * @param string $realm
	 *        	Name of the authentication session
	 * @param array $users
	 *        	An assoc array of username and password: array('uname1'=>'pwd1', 'uname2'=>'pwd2')
	 * @param string $fail_msg
	 *        	Message to be displayed if the User cancel the login
	 * @param string $fail_url
	 *        	URL to be redirect if the User cancel the login
