...
class Minify {
	 ...
	 * appear too late in the combined stylesheet.
	 * If found, serve() will prepend
	 ...
	 *
	 * @param mixed $cache
	 *        	object with identical interface as Minify_Cache_File or
	 *        	a directory path, or null to disable caching. (default = '')
	 *        	
	 * @param bool $fileLocking
	 *        	(default = true) This only applies if the first
	 ...
	 * 
	 * @see Minify_Lines::minify() 'minifiers' : to override Minify's default choice of minifier function for
	 ...
	 *        	instance of subclass of Minify_Controller_Base or string
	 *        	name of controller. E.g. 'Files'
	 *        	
	 * @param array $options
	 *        	controller/serve options
	 *        	
	 ...
	 *
	 * @param array $sources
	 *        	array of filepaths and/or Minify_Source objects
	 *        	
	 * @param array $options
	 *        	(optional) array of options for serve. By default
	 ...
	 * On IIS, the value is created from SCRIPT_FILENAME and SCRIPT_NAME.
	 *
	 * @param string $docRoot
	 *        	value to use for DOCUMENT_ROOT
	 */
	...
	/**
	 * Any Minify_Cache_* object or null (i.e.
