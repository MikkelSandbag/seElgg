...
class Minify_Build {
	...
	/**
	 * String to use as ampersand in uri().
	 * Set this to '&' if
	 ...
	 *
	 * @param string $uri        	
	 * @param boolean $forceAmpersand
	 *        	(default = false) Force the use of ampersand to
	 ...
	 *
	 * @param array $sources
	 *        	array of Minify_Source objects and/or file paths
	 *        	
	 * @return null
	 */
