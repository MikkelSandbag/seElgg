...
class Cli {
	...
	/**
	 *
	 * @param bool $exitIfNoStdin
	 *        	(default true) Exit() if STDIN is not defined
	 */
	...
	/**
	 * Get resource of open input stream.
	 * May be STDIN or a file pointer
	...
	/**
	 * Get resource of open output stream.
	 * May be STDOUT or a file pointer
