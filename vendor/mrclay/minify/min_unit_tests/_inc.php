 ...
 * 
 * @param mixed $test
 *        	Condition to test, evaluated as boolean
 * @param string $message
 *        	Descriptive message to output upon test
...
function countBytes($str) {
	return (function_exists ( 'mb_strlen' ) && (( int ) ini_get ( 'mbstring.func_overload' ) & 2)) ? mb_strlen ( $str, '8bit' ) : strlen ( $str );
}
