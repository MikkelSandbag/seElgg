 ...
 *
 * @param bool $forward
 *        	If set to true (default), will forward the page;
 *        	if set to false, will return true or false.
 *        	
 * @param int $group_guid
 *        	The group that owns the page. If not set, this
 ...
 *        	if set to false, will return true or false.
 *        	
 * @param int $page_owner_guid
 *        	The current page owner guid. If not set, this
 *        	will be pulled from elgg_get_page_owner_guid().
 *        	
 * @return bool Will return if $forward is set to false.
 */
 ...
 *        	Entity GUID
 * @param string $type
 *        	Optional required entity type
 * @param string $subtype
 *        	Optional required entity subtype
 * @return void
 * @since 1.9.0
 */
 ...
 * @param array $params
 *        	Parameters related to the hook
 * @return void
 */
