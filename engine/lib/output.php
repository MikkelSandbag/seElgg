 ...
 *
 * @param string $text
 *        	The full text to excerpt
 * @param int $num_chars
 *        	Return a string up to $num_chars long
 *        	
 * @return string
 * @since 1.7.2
 */
 ...
 *        	
 * @param int $precision
 *        	Precision to round formatting bytes to
 *        	
 * @return string
 * @since 1.9.0
 */
 ...
 *
 * @param array $attrs
 *        	An associative array of attr => val pairs
 *        	
 ...
 *        	The element tagName. e.g. "div". This will not be validated.
 *        	
 * @param array $attributes
 *        	The element attributes. This is passed to elgg_format_attributes().
 *        	
 * @param string $text
 *        	The contents of the element. Assumed to be HTML unless encode_text is true.
 *        	
 * @param array $options
 ...
 *
 * @param array $vars
 *        	The raw $vars array with all it's dirtiness (config, url, etc.)
 *        	
 ...
 *
 * @example elgg_normalize_url(''); // 'http://my.site.com/'
 ...
 *        	Current UNIX epoch timestamp (optional)
 *        	
...
function elgg_get_friendly_time($time, $current_time = null) {
	...
	return elgg_echo ( "friendlytime{$future}{$granularity}{$singular}", array (
			$diff 
	) );
}
 ...
 *        	The code as stored in $_FILES['name']['error']
 * @return string
 */
