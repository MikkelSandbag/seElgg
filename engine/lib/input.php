 ...
 * @param mixed $default
 *        	A default value for the variable if it is not found.
 * @param bool $filter_result
 *        	If true, then the result is filtered for bad tags.
 *        	
 * @return mixed
 */
 ...
 *
 * @param mixed $var
 *        	Anything that does not include an object (strings, ints, arrays)
 ...
 *        	The name of the variable
 * @param mixed $default
 *        	Default value if the variable does not exist in sticky cache
 * @param boolean $filter_result
 *        	Filter for bad input if true
 *        	
 * @return mixed
 *
 ...
 *
 * @param mixed $value
 *        	The value to remove slashes from
 *        	
 * @return mixed
 * @access private
 */
