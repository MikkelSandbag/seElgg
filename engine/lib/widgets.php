 ...
 *        	The widget context
 * @param int $user_guid
 *        	The GUID of the user (0 for logged in user)
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 * @param array $context
 *        	An array of contexts where this
 ...
 *
 * @param string $context
 *        	The widget context or empty string for current context
 * @param bool $exact
 *        	Only return widgets registered for this context (false)
 *        	
 * @return array
 * @since 1.8.0
 */
