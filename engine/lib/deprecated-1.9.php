 ...
 *        	Extender type ('annotation', 'metadata')
 ...
 *        	The site
 * @param bool $count
 *        	Return the users (false) or the count of them (true)
 *        	
 * @return mixed
 ...
 *        	The guid of the elgg object (must be \ElggObject or a child thereof)
 *        	
 * @return bool
 ...
 *
 * @param int $user_guid
 *        	The GUID of the friending user
 * @param int $friend_guid
 *        	The GUID of the user to friend
 *        	
 * @return bool Depending on success
 ...
 *        	The GUID of the friending user
 * @param int $friend_guid
 *        	The GUID of the user on the friends list
 *        	
 * @return bool Depending on success
 ...
 *
 * @param int $extender_id
 *        	The ID of the piece of extender
 * @param string $type
 ...
 *
 * @param string $action
 *        	Action performed on metadata. "delete", "disable", or "enable"
 * @param array $options
 *        	Options passed to elgg_(delete|disable|enable)_metadata
 * @return void
 * @deprecated 1.9
 */
 ...
 *        	Do we want to make the query case sensitive?
 ...
 *
 * @param string $string
 *        	The value (whatever that is) to be stored
 * @param bool $case_sensitive
 *        	Do we want to make the query case sensitive?
 *        	
 ...
 *
 * @param int $user_guid
 *        	The GUID of the user to get the friends of
 * @param string $subtype
 ...
 *        	Whether or not to allow you to flip to gallery mode (default: true)
 ...
 *        	The location, e.g. "London", or "24 Foobar Street, Gotham City"
 * @return string|false
...
function elgg_geocode_location($location) {
	...
	$return = false;
	$return = elgg_trigger_plugin_hook ( 'geocode', 'location', array (
			'location' => $location 
	), $return );
...
function elgg_get_entities_from_location(array $options = array()) {
	...
	if (! isset ( $options ['latitude'] ) || ! isset ( $options ['longitude'] ) || ! isset ( $options ['distance'] )) {
		return false;
	}
 ...
 *        	Whether to return a human readable version (default: false)
 *        	
 ...
 * @param string $extra_escapeable
 *        	Extra characters to escape with '\\'
 *        	
 ...
 *        	The type of link we want: "read", "write" or "readwrite".
 *        	
 ...
 *
 * @param string $table
 *        	The name of the table to optimise
 *        	
 * @return bool
 * @access private
 * @deprecated 1.9
 ...
 * @param resource $dblink
 *        	The database link to use or the link type (read | write)
 * @param string $handler
 *        	A callback function to pass the results array to
 *        	
 ...
 * @param boolean $count
 *        	Set to true to get a count instead of entities. Defaults to false.
 * @param int $site_guid
 *        	Site to get entities for. Default 0 = current site. -1 = any.
 * @param mixed $container_guid
 *        	Container or containers to get entities from (default: any).
 *        	
 * @return array|false
 * @access private
 * @deprecated 1.9
 ...
 *        	Site to get entities for. Default 0 = current site. -1 = any.
 * @param bool $count
 *        	If true, returns count instead of entities. (Default: false)
 *        	
...
function get_notable_entities_from_metadata($start_time, $end_time, $meta_name, $meta_value = "", $entity_type = "", $entity_subtype = "", $owner_guid = 0, $limit = 10, $offset = 0, $order_by = "", $site_guid = 0, $count = false) {
	...
	// Add access controls
	$query .= _elgg_get_access_where_sql ( array (
			'table_alias' => 'e' 
	) );
	$query .= ' and ' . _elgg_get_access_where_sql ( array (
			'table_alias' => "m" 
	) );
 ...
 *        	Reverse the normal function of the query to say
 ...
 *        	Offset
 * @param boolean $count
 *        	If true returns a count of entities (default false)
 * @param int $site_guid
 *        	Site to get entities for. Default 0 = current site. -1 = any
 *        	
 ...
 *        	Site to get entities for. Default 0 = current site. -1 = any
 * @param mixed $container_guid
 *        	Container(s) to get entities from (default: any).
 *        	
 * @return array|false
 * @access private
 * @deprecated 1.9
 ...
 *        	Optional viewtype to regenerate. Defaults to all valid viewtypes.
 *        	
 * @return void
 * @since 1.8.0
 ...
 * @param int $guid_two
 *        	This is the object trying to attach to $guid_one
 *        	
 * @return bool
 * @access private
 ...
 *        	Entity GUID
 * @param string $type
 *        	The type of object to return e.g. 'file', 'friend_of' etc
 *        	
 ...
 *        	This is the target object
 * @param int $guid_two
 *        	This is the object to remove from $guid_one
 *        	
 * @return void
 * @access private
 ...
 *
 * @param int $guid
 *        	The guid of the entity to delete
 * @param bool $recursive
 *        	If true (default) then all entities which are
 ...
 *
 * @param int $guid
 *        	GUID of entity to enable
 * @param bool $recursive
 *        	Recursively enable all entities disabled with the entity?
 *        	
 * @return bool
 ...
 *        	The metadata to specifically check (if any; default null)
 *        	
 ...
 *        	Optional reason
 * @param bool $recursive
 *        	Recursively disable all entities owned or contained by $guid?
 *        	
 * @return bool
 ...
 *
 * @param int $guid
 *        	The guid of the entity you're creating (as obtained by create_entity)
 * @param string $title
 ...
 *
 * @param mixed $object
 *        	The object either an \ElggEntity, \ElggRelationship or \ElggExtender
 *        	
...
function _process_element(ODD $odd) {
	...
	if ($odd) {
		$handled = elgg_trigger_plugin_hook ( "import", "all", array (
				"element" => $odd 
		), $to_be_serialised );
...
function exportAsArray($guid) {
	...
	// Trigger a hook to
	$to_be_serialised = elgg_trigger_plugin_hook ( "export", "all", array (
			"guid" => $guid 
	), array () );
 ...
 *
 * @param string $dir
 *        	The main directory that holds the views. (mod/profile/views/)
 * @param string $base
 *        	The root name of the view to use, without the viewtype. (profile)
 *        	
 * @return array
 * @since 1.7.0
 ...
 *        	The root view
 * @param string $viewtype
 *        	Optionally specify a view type
 ...
 *
 * @param string $view
 *        	The view that will handle the river item (must exist)
 * @param string $action_type
 *        	An arbitrary string to define the action (eg 'comment', 'create')
 * @param int $subject_guid
 *        	The GUID of the entity doing the action
 * @param int $object_guid
 *        	The GUID of the entity being acted upon
 * @param int $access_id
 *        	The access ID of the river item (default: same as the object)
 * @param int $posted
 *        	The UNIX epoch timestamp of the river item (default: now)
 * @param int $annotation_id
 *        	The annotation ID associated with this river entry
 * @param int $target_guid
 *        	The GUID of the the object entity's container
 *        	
 * @return int/bool River ID or false on failure
 * @deprecated 1.9 Use elgg_create_river_item()
 */
function add_to_river($view, $action_type, $subject_guid, $object_guid, $access_id = "", $posted = 0, $annotation_id = 0, $target_guid = 0) {
 ...
 *        	Its localized notification string (eg "New blog post")
 *        	
 * @return void
 ...
 *
 * @param int $user_guid
 *        	The GUID of the user who wants to follow a user's content
 * @param int $author_guid
 *        	The GUID of the user whose content the user wants to follow
 *        	
 * @return bool Depending on success
 ...
 *
 * @param int $user_guid
 *        	The GUID of the user who is following a user's content
 * @param int $author_guid
 *        	The GUID of the user whose content the user wants to unfollow
 *        	
 * @return bool Depending on success
 ...
 *        	The method
 * @param string $handler
 *        	The handler function, in the format
 ...
 * @param array $params
 *        	An associated array of other parameters for this handler
 ...
 *        	Value from previous hook
 * @param mixed $params
 *        	Array of params
 *        	
 * @return mixed @elgg_plugin_hook_handler import all
 * @todo document
 * @access private
 *        
 ...
 * @param array $params
 *        	The parameters, passed 'guid' and 'varname'
 *        	
 * @return \ElggMetadata|null @elgg_plugin_hook_handler volatile metadata
 ...
 * @param mixed $params
 *        	Parameters determining what annotations to export
 *        	
 ...
 *        	The parameters
 *        	
 * @return null @elgg_plugin_hook_handler volatile metadata
 * @todo investigate more.
 * @throws ImportException
 * @access private
 * @deprecated 1.9
 ...
 * an ODDMetaData and add it to an entity.
 * This function does not
 * hit ->save() on the entity (this lets you construct in memory)
 *
 * @param \ElggEntity $entity
 *        	The entity to add the data to.
 * @param ODDMetaData $element
 *        	The OpenDD element
 *        	
 * @return bool
 * @access private
 ...
 *        	all
 * @param mixed $returnvalue
 *        	Value returned from previous hook
 * @param mixed $params
 *        	Params
 *        	
 * @return array
 ...
 *        	Optional table prefix for the access code.
 * @param int $owner
 *        	Optional user guid to get access information for. Defaults
 *        	to logged in user.
 * @return string
 * @access private
