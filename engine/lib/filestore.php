 ...
 * @param bool $square
 *        	If set to true, takes the smallest of maxwidth and
 ...
 * @param int $x2
 *        	x coordinate for bottom, right corner
 * @param int $y2
 *        	y coordinate for bottom, right corner
 * @param bool $upscale
 *        	Resize images smaller than $maxwidth x $maxheight?
 *        	
 * @return false|mixed The contents of the resized image, or false on failure
 ...
 *
 * @param \ElggFilestore $filestore
 *        	An \ElggFilestore object.
 *        	
 * @return true
 */
