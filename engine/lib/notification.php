 ...
 *        	'object', 'user', 'group', 'site'
 * @param string $object_subtype
 *        	The subtype or name of the entity
 * @param array $actions
 *        	Array of actions or empty array for the action event.
 ...
 *
 * @param int $user_guid
 *        	The GUID of the user to subscribe to notifications
 * @param string $method
 *        	The delivery method of the notifications
 * @param int $target_guid
 *        	The entity to receive notifications about
 * @return bool
 * @since 1.9
 */
 ...
 *
 * @param int $user_guid
 *        	The GUID of the user to unsubscribe to notifications
 * @param string $method
 *        	The delivery method of the notifications to stop
 * @param int $target_guid
 *        	The entity to stop receiving notifications about
 * @return bool
 * @since 1.9
 */
 ...
 *        	GUID of the entity acting as a container
 ...
 *        	Array containing fields: 'to', 'from', 'subject', 'body', 'headers', 'params'
 * @param array $params
 *        	The same value as $returnvalue
 * @return array
 * @access private
 */
 ...
 *
 * @param mixed $to
 *        	Either a guid or an array of guid's to notify.
 * @param int $from
 *        	GUID of the sender, which may be a user, site or object.
 * @param string $subject
 *        	Message subject.
 * @param string $message
 *        	Message body.
 * @param array $params
 *        	Misc additional parameters specific to various methods.
 * @param mixed $methods_override
			...
			if ($methods) {
				...
				foreach ( $methods as $method ) {
					...
					if (_elgg_services ()->hooks->hasHandler ( 'send', "notification:$method" )) {
						...
						$result [$guid] [$method] = _elgg_notify_user ( $guid, $from, $subject, $message, $params, array (
								$method 
						) );
					}
				}
 ...
 *
 * @param string $from
 *        	Email address or string: "name <email>"
 * @param string $to
 *        	Email address or string: "name <email>"
 * @param string $subject
 ...
 *        	The message body
 * @param array $params
 *        	Optional parameters (none used in this function)
 *        	
 * @return bool
 * @throws NotificationException
 * @since 1.7.2
