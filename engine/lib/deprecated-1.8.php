 ...
 *            
 * @param string $action
 *        	The name of the action (eg "register", "account/settings/save")
 * @param boolean $public
 *        	Can this action be accessed by people not logged into the system?
 * @param string $filename
 *        	Optionally, the filename where this action is located
 ...
 *            
 * @param string $new_admin_view
 *        	The view associated with the control you're adding
 * @param string $view
 *        	The view to extend, by default this is 'admin/main'.
 * @param int $priority
 *        	Optional priority to govern the appearance in the list.
 *        	
 * @return void
 */
 ...
 *            
 * @param string $sum
 *        	What sort of calculation to perform
 ...
 *        	Group container. Currently only supported if entity_type is object
 * @param boolean $asc
 *        	Whether to list in ascending or descending order (default: desc)
 * @param boolean $fullview
 *        	Whether to display the entities in full
 * @param boolean $listtypetoggle
 *        	Can the 'gallery' view can be displayed (default: no)
 ...
 *        	The name of the top-level register
 * @param string $subregister_name
 *        	The name of the subregister
 * @param mixed $subregister_value
 *        	The value of the subregister
 * @param array $children_array
 *        	Optionally, an array of children
 *        	
 ...
 * Code divided between elgg_register_event_handler()
 * and trigger_elgg_event().
 *
 * @deprecated 1.8 Use explicit register/trigger event functions
 *            
 * @param string $event
 *        	The type of event (eg 'init', 'update', 'delete')
 * @param string $object_type
 *        	The type of object (eg 'system', 'blog', 'user')
 * @param string $function
 *        	The name of the function that will handle the event
 * @param int $priority
 *        	Priority to call handler. Lower numbers called first (default 500)
 * @param boolean $call
 *        	Set to true to call the event rather than add to it (default false)
 * @param mixed $object
 *        	Optionally, the object the event is being performed on (eg a user)
 *        	
 * @return true|false Depending on success
 */
 ...
 * @param string $entity_type
 *        	The name of the type of entity (eg "user", "object" etc)
 * @param string $function
 *        	The name of a valid function to be run
 * @param string $priority
 *        	The priority - 0 is first, 1000 last, default is 500
 * @return true|false Depending on success
 */
 ...
 * @param string $entity_type
 *        	The name of the entity type to trigger it for (or "all", or "none")
 * @param array $params
 *        	Any parameters. It's good practice to name the keys, i.e. by using array('name' => 'value', 'name2' => 'value2')
 ...
 *        	The function that this function must have in its call stack,
 *        	to test against a method pass an array containing a class and
 *        	method name.
 * @param string $file
 *        	Optional file that the function must reside in.
 *        	
 * @return bool
 *
 ...
 *
 * @param string $path
 *        	The full path and filename that this function must have
 ...
 *        	Are subdirectories of the path ok, or must you specify an
 *        	absolute path and filename.
 * @param bool $strict_mode
 *        	If true then the calling method or function must be directly
 ...
 *            
 * @param string $table
 *        	Entity table prefix as defined in SELECT...FROM entities $table
 ...
 *
 * @param int $group_guid
 *        	The container (defaults to current page owner)
 ...
 *        	Order
 * @param int $limit
 *        	Limit on number of elements to return, by default 10.
 * @param int $offset
 *        	Where to start, by default 0.
 * @param bool $count
 *        	Whether to return the entities or a count of them.
 *        	
 * @return array|false
 ...
 *
 * @param string $subtype
 *        	The arbitrary subtype of the entity
 * @param int $owner_guid
 *        	The GUID of the owning user
 * @param int $container_guid
 *        	The GUID of the containing group
 * @param int $limit
 *        	The number of entities to display per page (default: 10)
 * @param bool $fullview
 *        	Whether or not to display the full view (default: true)
 * @param bool $listtypetoggle
 *        	Whether or not to allow gallery view (default: true)
 * @param bool $pagination
 *        	Whether to display pagination (default: true)
 *        	
 ...
 *        	Metadata value
 * @param string $entity_type
 *        	The type of entity to look for, eg 'site' or 'object'
 * @param string $entity_subtype
 ...
 *        	Optional ordering.
 * @param int $site_guid
 *        	Site GUID. 0 for current, -1 for any
 * @param bool $count
 ...
 *        	Site GUID. 0 for current, -1 for any
 * @param bool $count
 *        	Return count of entities instead of entities
 *        	
 ...
 *        	The radius
 * @param string $type
 *        	The type of entity (eg "user", "object" etc)
 * @param string $subtype
 *        	The arbitrary subtype of the entity
 * @param int $owner_guid
 *        	The GUID of the owning user
 ...
 *        	Whether or not to display the full view (default: true)
 * @param bool $listtypetoggle
 *        	Whether or not to allow gallery view
 ...
 *        	The GUID of the owning user
 * @param string $order_by
 *        	The field to order by; by default, time_created desc
 * @param int $limit
 *        	The number of entities to return; 10 by default
 * @param int $offset
 *        	The indexing offset, 0 by default
 * @param boolean $count
 *        	Count entities
 * @param int $site_guid
 *        	Site GUID. 0 for current, -1 for any
 * @param int|array $container_guid
 *        	Container GUID
 *        	
 ...
 *            
 * @param mixed $meta_name
 *        	Metadata name to search on
 * @param mixed $meta_value
 *        	The value to match, optionally
 * @param string $entity_type
 *        	The type of entity to look for, eg 'site' or 'object'
 * @param string $entity_subtype
 *        	The subtype of the entity
 ...
 *        	Owner GUID
 * @param int $limit
 *        	Number of entities to display per page
 * @param bool $fullview
 *        	WDisplay the full view (default: true)
 * @param bool $listtypetoggle
 *        	Allow users to toggle to the gallery view. Default: true
 * @param bool $pagination
 *        	Display pagination? Default: true
 * @param bool $case_sensitive
 *        	Case sensitive metadata names?
 *        	
 * @return string
 *
 ...
 *        	The link
 * @param string $group
 *        	The group to store item in
 * @param boolean $onclick
 *        	Add a confirmation when clicked?
 ...
 *        	The URL of the page
 * @param array $menu_children
 *        	Optionally, an array of submenu items (not used)
 ...
 *        	Optionally, a list of existing plugins and their orders
 *        	
 ...
 *            
 * @param boolean $mainfilename
 *        	If set to true, this will instead determine the
 ...
 *            
 * @param string $manifest_elgg_version_string
 *        	The build version (eg 2009010201).
 * @return bool
 */
 ...
 *        	Optional plugin id, if not specified
 ...
 *        	The plugin name.
 * @param int $site_guid
 *        	The site id, if not specified then this is detected.
 *        	
 * @return array
 ...
 * @param int $site_guid
 *        	The site to get entities for. 0 for current, -1 for any
 * @param mixed $container_guid
 *        	The container(s) GUIDs
 *        	
 * @return array A list of entities.
 ...
 *        	The relationship eg "friends_of"
 * @param int $relationship_guid
 *        	The guid of the entity to use query
 * @param bool $inverse_relationship
 *        	Reverse the normal function of the query to instead say "give me all entities for whome $relationship_guid is a $relationship of"
 * @param string $type
 *        	The type of entity (eg 'object')
 * @param string $subtype
 *        	The entity subtype
 * @param int $owner_guid
 *        	The owner (default: all)
 * @param int $limit
 *        	The number of entities to display on a page
 * @param true|false $fullview
 *        	Whether or not to display the full view (default: true)
 * @param true|false $viewtypetoggle
 *        	Whether or not to allow gallery view
 * @param true|false $pagination
 *        	Whether to display pagination (default: true)
 * @param bool $order_by
 *        	SQL order by clause
 ...
 *        	The relationship eg "friends_of"
 * @param bool $inverse_relationship
 *        	Inverse relationship owners
 * @param string $type
 *        	The type of entity (default: all)
 * @param string $subtype
 *        	The entity subtype (default: all)
 * @param int $owner_guid
 *        	The owner of the entities (default: none)
 * @param int $limit
 *        	Limit
 * @param int $offset
 *        	Offset
 * @param bool $count
 *        	Return a count instead of entities
 * @param int $site_guid
 *        	Site GUID
 *        	
 ...
 *
 * @param int|array $subject_guid
 *        	Acting entity to restrict to. Default: all
 * @param int|array $object_guid
 *        	Entity being acted on to restrict to. Default: all
 * @param string $subject_relationship
 *        	If set to a relationship type, this will use
 *        	$subject_guid as the starting point and set the
 *        	subjects to be all users this
 *        	entity has this relationship with (eg 'friend').
 *        	Default: blank
 * @param string $type
 *        	The type of entity to restrict to. Default: all
 * @param string $subtype
 *        	The subtype of entity to restrict to. Default: all
 * @param string $action_type
 *        	The type of river action to restrict to. Default: all
 * @param int $limit
 *        	The number of items to retrieve. Default: 20
 * @param int $offset
 *        	The page offset. Default: 0
 * @param int $posted_min
 *        	The minimum time period to look at. Default: none
 * @param int $posted_max
 *        	The maximum time period to look at. Default: none
 *        	
 * @return array|false Depending on success
...
function elgg_view_river_items($subject_guid = 0, $object_guid = 0, $subject_relationship = '', $type = '', $subtype = '', $action_type = '', $limit = 20, $posted_min = 0, $posted_max = 0, $pagination = true) {
	...
	$river_items = get_river_items ( $subject_guid, $object_guid, $subject_relationship, $type, $subtype, $action_type, $limit + 1, $posted_min, $posted_max );
	...
	foreach ( $activity_events as $details ) {
		...
		if (($details ['type']) && ($details ['event'])) {
			...
			if ($details ['type'] != 'relationship') {
				$access = " and " . _elgg_get_access_where_sql ( array (
						'table_alias' => 'sl' 
				) );
			}
 ...
 *        	The username, optionally (for standard logins)
 * @param string $password
 *        	The password, optionally (for standard logins)
 *        	
 ...
 * @param int $limit
 *        	The number of members to display on a page
 * @param bool $fullview
 *        	Whether or not to display the full view (default: true)
 *        	
 ...
 *            
 * @param int $threshold
 *        	Get the threshold of minimum number of each tags to
 *        	bother with (ie only show tags where there are more
 *        	than $threshold occurances)
 * @param int $limit
 *        	Number of tags to return
 * @param string $metadata_name
 *        	Optionally, the name of the field you want to grab for
 * @param string $entity_type
 *        	Optionally, the entity type ('object' etc)
 * @param string $entity_subtype
 *        	The entity subtype, optionally
 * @param int $owner_guid
 *        	The GUID of the tags owner, optionally
 * @param int $site_guid
 *        	Optionally, the site to restrict to (default is the current site)
 * @param int $start_ts
 *        	Optionally specify a start timestamp for tags used to
 *        	generate cloud.
 * @param int $end_ts
 *        	Optionally specify an end timestamp for tags used to generate cloud
 *        	
 ...
 *            
 * @param int $threshold
 *        	Get the threshold of minimum number of each tags
 ...
 *        	generate cloud.
 * @param int $end_ts
 *        	Optionally specify an end timestamp for tags used to generate
 *        	cloud.
 *        	
 ...
 *        	The GUID of the owning user
 * @param string $subtype
 *        	Optionally, the subtype of objects
 * @param int $limit
 *        	The number of results to return (default 10)
 * @param int $offset
 *        	Indexing offset, if any
 * @param int $timelower
 *        	The earliest time the entity can have been created. Default: all
 * @param int $timeupper
 *        	The latest time the entity can have been created. Default: all
 *        	
 ...
 * @param string $method
 *        	Optional method to say how a user was validated
 * @return bool
 ...
 * At the moment this is essentially a wrapper around elgg_extend_view().
 *
 * @param string $new_settings_view
 *        	The view associated with the control you're adding
 * @param string $view
 *        	The view to extend, by default this is 'usersettings/main'.
 * @param int $priority
 *        	Optional priority to govern the appearance in the list.
 *        	
 * @return bool
 ...
 *
 * @param string $icon
 *        	The icon for the listing
 * @param string $info
 *        	Any information that needs to be displayed.
 *        	
...
function get_entity_icon_url(\ElggEntity $entity, $size = 'medium') {
	...
	if (! $url) {
		...
		if (! empty ( $subtype )) {
			$overrideurl = elgg_view ( "icon/{$type}/{$subtype}/{$size}", array (
					'entity' => $entity 
			) );
		...
		$overrideurl = elgg_view ( "icon/{$type}/default/{$size}", array (
				'entity' => $entity 
		) );
		if (! empty ( $overrideurl )) {
			return $overrideurl;
 ...
 *        	Plugin name.
 * @param int $user_guid
 *        	The guid who's settings to retrieve.
 *        	
 ...
 *
 * @param string $name
 *        	The name - note, can't be "title".
 * @param mixed $value
 *        	The value.
 * @param int $user_guid
 *        	Optional user.
 * @param string $plugin_id
 *        	Optional plugin name, if not specified then it
 ...
 *
 * @param string $name
 *        	Name of the plugin setting
 * @param int $user_guid
 *        	Defaults to logged in user
 * @param string $plugin_id
 *        	Defaults to contextual plugin name
 *        	
 ...
 *        	Guid of owning user
 * @param string $plugin_id
 *        	Optional plugin name, if not specified
 ...
 *        	GUID to return annotations of (falsey for any)
 * @param string $entity_type
 *        	Type of entity
 * @param string $entity_subtype
 *        	Subtype of entity
 ...
 *        	Owner(s) of annotation
 * @param int $limit
 *        	Limit
 * @param int $offset
 *        	Offset
 * @param string $order_by
 *        	Order annotations by SQL
 * @param int $timelower
 *        	Lower time limit
 * @param int $timeupper
 *        	Upper time limit
 * @param int $entity_owner_guid
 *        	Owner guid for the entity
 *        	
 * @return array
 * @deprecated 1.8 Use elgg_get_annotations()
 */
function get_annotations($entity_guid = 0, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $owner_guid = 0, $limit = 10, $offset = 0, $order_by = "asc", $timelower = 0, $timeupper = 0, $entity_owner_guid = 0) {
 ...
 *        	The entity GUID
 * @param string $name
 *        	The name of the kind of annotation
 * @param int $limit
 *        	The number of annotations to display at once
 * @param true|false $asc
 *        	Display annotations in ascending order. (Default: true)
 *        	
 ...
 * @deprecated 1.8 Use elgg_get_annotations()
 */
function elgg_deprecated_annotation_calculation($entity_guid = 0, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0, $timelower = 0, $timeupper = 0, $calculation = '') {
	$options = array (
...
function count_annotations($entity_guid = 0, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0, $timelower = 0, $timeupper = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, $timelower, $timeupper, 'count' );
}
...
function get_annotations_sum($entity_guid, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, 0, 0, 'sum' );
}
...
function get_annotations_max($entity_guid, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, 0, 0, 'max' );
}
...
function get_annotations_min($entity_guid, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, 0, 0, 'min' );
}
...
function get_annotations_avg($entity_guid, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, 0, 0, 'avg' );
}
 ...
 */
function get_annotations_calculate_x($sum = "avg", $entity_guid, $entity_type = "", $entity_subtype = "", $name = "", $value = "", $value_type = "", $owner_guid = 0, $timelower = 0, $timeupper = 0) {
	...
	return elgg_deprecated_annotation_calculation ( $entity_guid, $entity_type, $entity_subtype, $name, $value, $value_type, $owner_guid, $timelower, $timeupper, $sum );
}
 ...
 *
 * @param int $id
 *        	The id of the metadata being retrieved.
 *        	
...
function clear_metadata($guid) {
	...
	return elgg_delete_metadata ( array (
			'guid' => $guid,
			'limit' => 0 
	) );
}
...
function clear_metadata_by_owner($owner_guid) {
	...
	return elgg_delete_metadata ( array (
			'metadata_owner_guid' => $owner_guid,
			'limit' => 0 
	) );
}
 ...
 * @param string $value
 *        	The value of the metadata (useful to remove a single item of a set)
 *        	
 ...
 * @param string $function_name
 *        	The function.
 * @param string $extender_name
 *        	The name, default 'all'.
 *        	
 ...
 *
 * @param string $type
 *        	The type of entity (object, site, user, group)
 * @param string $subtype
 *        	The subtype to register (may be blank)
 * @return true|false Depending on success
 *        
 ...
 *        	Optional viewtype to regenerate
 ...
 *        	Mixed PAM handler specific credentials (e.g. username, password)
 * @param string $policy
 *        	- the policy type, default is "user"
 ...
 *
 * @param \ElggObject $widget
 *        	The widget entity
 * @param int $order
 *        	The order within the column
 * @param int $column
 *        	The column (1, 2 or 3)
 *        	
 * @return bool Depending on success
 ...
 *        	The owner user GUID
 * @param string $context
 *        	The context (profile, dashboard etc)
 * @param int $column
 *        	The column (1 or 2)
 *        	
 ...
 *
 * @param int $entity_guid
 *        	GUID of entity that owns this widget
 * @param string $handler
 *        	The handler for this widget
 * @param string $context
 *        	The page context for this widget
 * @param int $order
 *        	The order to display this widget in
 * @param int $column
 *        	The column to display this widget in (1, 2 or 3)
 * @param int $access_id
 *        	If not specified, it is set to the default access level
 *        	
 ...
 *
 * @param string $handler
 *        	The identifier for the widget handler
 * @param string $name
 *        	The name of the widget type
 * @param string $description
 *        	A description for the widget type
 * @param string $context
 *        	A comma-separated list of contexts where this
 *        	widget is allowed (default: 'all')
 * @param bool $multiple
 *        	Whether or not multiple instances of this widget
 *        	are allowed on a single dashboard (default: false)
 * @param string $positions
 *        	A comma-separated list of positions on the page
 ...
 *
 * @param string $handler
 *        	The widget handler identifying string
 *        	
 ...
 *        	The GUID of the widget we're saving to
 * @param array $params
 *        	An array of name => value parameters
 *        	
 * @return bool
 ...
 *
 * @param string $panelstring1
 *        	String of guids of \ElggWidget objects separated by ::
 * @param string $panelstring2
 *        	String of guids of \ElggWidget objects separated by ::
 * @param string $panelstring3
 *        	String of guids of \ElggWidget objects separated by ::
 * @param string $context
 ...
 *
 * @param string $context
 *        	The context we wish to enable context for
 *        	
 * @return void
 * @deprecated 1.8 Don't use.
 */
 ...
 * Tries to locate a suitable file to include.
 * Only works for core pages, not plugins.
 *
 * @param array $page
 *        	The page URL elements
 * @param string $handler
 *        	The base handler
 *        	
 * @return true|false Depending on success
