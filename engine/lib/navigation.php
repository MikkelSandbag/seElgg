 ...
 *        	The name of the menu: site, page, userhover,
 *        	userprofile, groupprofile, or any custom menu
 * @param mixed $menu_item
 *        	A \ElggMenuItem object or an array of options in format:
 ...
 *        	The handler to use or null to autodetect from context
 * @param string $name
 *        	Name of the button
 * @return void
 * @since 1.8.0
 ...
 * @param string $link
 *        	Optional. The link for the title.
 *        	
 * @return void
 * @since 1.8.0
 */
...
function _elgg_widget_menu_setup($hook, $type, $return, $params) {
	...
	if ($widget->canEdit ()) {
		$delete = array (
				...
				'title' => elgg_echo ( 'widget:delete', array (
						$widget->getTitle () 
				) ),
