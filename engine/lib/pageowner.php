 ...
 *
 * @param int $guid
 *        	Optional parameter used by elgg_set_page_owner_guid().
 *        	
 ...
 *
 * @param string $context
 *        	The context string to add to the context stack
 * @return void
 * @since 1.8.0
 */
 ...
 *
 * @param string $context
 *        	The context string to check for
 * @return bool
 * @since 1.8.0
 */
