 ...
 *        	Associated array of credentials passed to
 ...
 * For standard registration, use in conjunction
 * with elgg_authenticate.
 *
 * @see elgg_authenticate
 *
 * @param \ElggUser $user
 *        	A valid Elgg user object
 * @param boolean $persistent
 *        	Should this be a persistent login?
 *        	
