 ...
 *          
 * @param bool $ignore
 *        	If true, disables all access checks.
 *        	
 ...
 *
 * @param \ElggUser $user
 *        	Get the user's default access. Defaults to logged in user.
 *        	
 ...
 *
 * @param array $options
 *        	Any options accepted by {@link elgg_get_entities()} and
 ...
 *
 * @param array $options
 *        	See elgg_list_entities() and elgg_get_entities_from_access_id()
 *        	
 ...
 *      
 * @param int $entity_access_id
 *        	The entity's access id
 * @return string
 * @since 1.7.0
 */
