 ...
 *        	Should the retrieval be case sensitive?
 ...
 *
 * @param string $table
 *        	The annotation or metadata table name or alias
 * @param array $names
 *        	An array of names
 * @param array $values
 *        	An array of values
 * @param array $pairs
 *        	Name / value pairs. Not currently used.
 * @param array $ids
 *        	Metastring IDs
 * @param bool $case_sensitive
 *        	Should name and values be case sensitive?
 *        	
 * @return array
 * @access private
 */
 ...
 *        	Value to set to: yes or no
 * @param string $type
 *        	Metastring type: metadata or annotation
 *        	
 * @return bool
 ...
 *
 * @param array $options
 *        	An options array. {@link _elgg_get_metastring_based_objects()}
 * @param string $callback
 *        	The callback to pass each result through
 * @param bool $inc_offset
 *        	Increment the offset? Pass false for callbacks that delete / disable
 *        	
 ...
 *
 * @param int $id
 *        	The metastring-based object's ID
 * @param string $type
 *        	The type: annotation or metadata
 * @return \ElggExtender
 * @access private
 */
 ...
 *        	The object's ID
 * @param string $type
 *        	The object's metastring type: annotation or metadata
 * @return bool
 * @access private
 */
 ...
 *
 * @param string $type
 *        	Metastring type: annotation or metadata
 * @param array $options
 *        	Options
 *        	
 * @return array
