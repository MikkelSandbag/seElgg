 ...
 *        	URL for entity
 * @param array $params
 *        	Array with the elgg entity passed in as 'entity'
 *        	
 * @return string
 * @access private
 */
 ...
 *        	Can the current user write to this container?
 * @param array $params
 *        	Array of parameters (container, user, subtype)
 *        	
 * @return array
 * @access private
 ...
 *        	'object'
 * @param boolean $return
 *        	Can the given user edit the given entity?
 * @param array $params
 *        	Array of parameters (entity, user)
 *        	
 ...
 *        	Current mail parameters
 * @param array $params
 *        	Original mail parameters
