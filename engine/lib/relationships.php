 ...
 *
 * @param \stdClass $row
 *        	Database row from the relationship table
 *        	
 ...
 *
 * @param int $guid_one
 *        	GUID of the subject entity of the relationship
 ...
 *
 * @param int $guid
 *        	GUID of the subject or target entity (see $inverse)
 * @param string $relationship
 *        	Type of the relationship (optional, default is all relationships)
 * @param bool $inverse_relationship
 *        	Is $guid the target of the deleted relationships? By default, $guid is the
 *        	subject of the relationships.
 * @param string $type
 *        	The type of entity related to $guid (defaults to all)
 *        	
 * @return true
 */
 ...
 *        	GUID of the subject or target entity (see $inverse)
 * @param bool $inverse_relationship
 *        	Is $guid the target of the deleted relationships? By default $guid is
 ...
 *      
 * @param string $column
 *        	Column name the GUID should be checked against.
 ...
 * @param bool $inverse_relationship
 *        	Is $relationship_guid the target of the relationship?
 *        	
 * @return mixed
 * @since 1.7.0
 * @access private
 */
function elgg_get_entity_relationship_where_sql($column, $relationship = null, $relationship_guid = null, $inverse_relationship = false) {
	return _elgg_services ()->relationshipsTable->getEntityRelationshipWhereSql ( $column, $relationship, $relationship_guid, $inverse_relationship );
}
 ...
 *
 * @param array $options
 *        	Options array for retrieval of entities
 *        	
 ...
 *
 * @param array $options
 *        	An options array compatible with elgg_get_entities_from_relationship()
 *        	
