 ...
 *        	URL segments that make up action name
 *        	
 * @return void
 * @access private
 */
 ...
 *        	Optionally, the location to forward to
 *        	
 ...
 *        	Optionally, the filename where this action is located. If not specified,
 *        	will assume the action is in elgg/actions/<action>.php
 * @param string $access
 *        	Who is allowed to execute this action: public, logged_in, admin.
 *        	(default: logged_in)
 *        	
 * @return bool
 */
 ...
 *
 * @param bool $visible_errors
 *        	Emit {@link register_error()} errors on failure?
 * @param mixed $token
 *        	The token to test against. Default: $_REQUEST['__elgg_token']
 * @param mixed $ts
 *        	The time stamp to test against. Default: $_REQUEST['__elgg_ts']
 *        	
 * @return bool
