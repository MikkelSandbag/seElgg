 ...
 *        	plugin
 * @param array $params
 *        	Parameters array containing entry with ELggPlugin instance under 'plugin_entity' key
...
function _plugins_deactivate_dependency_check($event, $type, $params) {
	...
	if ($dependents) {
		...
		register_error ( elgg_echo ( 'ElggPlugin:Dependencies:ActiveDependent', array (
				$plugin_name,
				$list 
		) ) );
