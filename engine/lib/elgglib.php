 ...
 *
 * @param string $location
 *        	URL to forward to browser to. This can be a path
 *        	relative to the network's URL.
 * @param string $reason
 *        	Short explanation for why we're forwarding. Set to
 ...
 *
 * @param string $name
 *        	An identifier for the JavaScript library
 * @param string $url
 *        	URL of the JavaScript file
 * @param string $location
 *        	Page location: head or footer. (default: head)
 * @param int $priority
 *        	Priority of the JS file (lower numbers load earlier)
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 *
 * @param string $name
 *        	The identifier for the JavaScript library
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 *
 * @param string $name
 *        	Identifier of the JavaScript resource
 *        	
 * @return void
 * @since 1.8.0
 */
 ...
 *
 * @param string $name
 *        	An identifier for the CSS file
 * @param string $url
 *        	URL of the CSS file
 * @param int $priority
 *        	Priority of the CSS file (lower numbers load earlier)
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 *
 * @param string $name
 *        	The identifier for the CSS file
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 *
 * @param string $type
 *        	Type of external resource (js or css)
 * @param string $name
 *        	Identifier used as key
 * @param string $url
 *        	URL
 * @param string $location
 *        	Location in the page to include the file
 * @param int $priority
 *        	Loading priority of the file
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 *          
 * @param mixed $message
 *        	Optionally, a single message or array of messages to add, (default: null)
 * @param string $register
 *        	Types of message: "error", "success" (default: success)
 * @param bool $count
 *        	Count the number of messages (default: false)
 *        	
 ...
 * @param int $priority
 *        	The priority - 0 is default, negative before, positive after
 *        	
 * @return bool
 ...
 *
 * @param string $event
 *        	The event type. The fired event type will be appended with ":before".
 * @param string $object_type
 *        	The object type
 * @param string $object
 *        	The object involved in the event
 ...
 *
 * @param string $event
 *        	The event type. The fired event type will be appended with ":after".
 * @param string $object_type
 *        	The object type
 * @param string $object
 *        	The object involved in the event
 ...
 *        	Human-readable *release* version: 1.9, 1.10, ...
 *        	
 * @return bool
 *
 * @see elgg_trigger_event
 ...
 *        	The name of a valid function or an array with object and method
 * @param int $priority
 *        	The priority - 500 is default, lower numbers called first
 *        	
 * @return bool
 *
 ...
 * @param callable $callback
 *        	The PHP callback to be removed
 *        	
 * @return void
 * @since 1.8.0
 */
 ...
 *
 * @param string $hook
 *        	The name of the hook to trigger ("all" will
 *        	trigger for all $types regardless of $hook value)
 * @param string $type
 *        	The type of the hook to trigger ("all" will
 ...
 * @warning This function should never be called directly.
 *
 * @internal For catchable fatal errors, throws an Exception with the error.
 *          
 ...
 * @param array $vars
 *        	An array that points to the active symbol table where error occurred
 *        	
 * @return true
 * @throws Exception
 * @access private
 ...
 * @param string $dep_version
 *        	Human-readable *release* version: 1.7, 1.8, ...
 * @param int $backtrace_level
 *        	How many levels back to display the backtrace.
 ...
 *
 * @param array $parts
 *        	Associative array of URL components like parse_url() returns
 ...
 *        	Full action URL
 * @param bool $html_encode
 *        	HTML encode the url? (default: false)
 *        	
...
function elgg_http_remove_url_query_element($url, $element) {
	return elgg_http_add_url_query_elements ( $url, array (
			$element => null 
	) );
}
 ...
 *        	Key/value pairs to set in the URL. If the value is null, the
 ...
 *        	GET params to ignore in the comparison
 *        	
 * @return bool
 * @since 1.8.0
 */
 ...
 * @param bool $strict
 *        	Return array key if it's set, even if empty. If false,
 ...
 *
 * @param array $options
 *        	The options array. $options['keys'] = 'values';
 * @param array $singulars
 *        	A list of singular words to pluralize by adding 's'.
 *        	
 * @return array
 * @since 1.7.0
 * @access private
 ...
 *        	The page array
 *        	
 * @return bool @elgg_pagehandler js
 * @access private
 */
 ...
 *
 * @param array $page
 *        	Array of URL segements
 * @return bool
 *
 * @see elgg_register_ajax_view() @elgg_pagehandler ajax
 * @access private
 */
 ...
 *        	The page array
 *        	
 * @return bool @elgg_pagehandler css
 * @access private
 */
 ...
 *        	Options array
 * @param string $type
 *        	Options type: metadata or annotation
 * @return bool
 * @access private
 */
...
/**
 * Alternate spelling for REFERRER.
 * Included because of some bad documentation
