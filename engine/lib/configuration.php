 ...
 *
 * @param int $site_guid
 *        	The GUID of the site whose URL we want to grab
 * @return string
 * @since 1.8.0
 */
 ...
 * @param int $site_guid
 *        	null for installation setting, 0 for default site
 *        	
 ...
 *
 * @param string $name
 *        	Configuration name (cannot be greater than 255 characters)
 * @param mixed $value
 *        	Configuration value. Should be string for installation setting
 * @param int $site_guid
 *        	null for installation setting, 0 for default site
 *        	
 * @return bool
 ...
 * @param int $timelastupdatedcheck
 *        	A UNIX timestamp. If time() is > than this,
 ...
 * @param int $site_guid
 *        	Optionally, the GUID of the site (default: current site).
 *        	
 ...
 *        	Its value
 * @param int $site_guid
 *        	Optionally, the GUID of the site (current site is assumed by default)
 *        	
 * @return bool
 * @see unset_config()
 * @see get_config()
