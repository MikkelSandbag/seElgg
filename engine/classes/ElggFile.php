...
class ElggFile extends \ElggObject {
	...
	/**
	 * File handle used to identify this file in a filestore.
	 * Created by open.
	 */
	private $handle;
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database result or null for new \ElggFile
	 */
	 ...
	 *        	The container GUID of the checked filestore
	 *        	
	 * @return int
	 */
	 ...
	 *
	 * @param mixed $file
	 *        	The full path of the file to check. For uploaded files, use tmp_name.
	 * @param mixed $default
	 *        	A default. Useful to pass what the browser thinks it is.
	 * @since 1.7.12
	 *       
