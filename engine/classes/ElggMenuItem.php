...
class ElggMenuItem {
	 ...
	 * @param string $text
	 *        	Display text of the menu item (HTML)
	 * @param string $href
	 *        	URL of the menu item (false if not a link)
	 */
	 ...
	 *
	 * @param array $options
	 *        	Option array of key value pairs
	 *        	
	 ...
	 *
	 * @param mixed $key
	 *        	String key or an associative array of key/value pairs
	 * @param mixed $value
	 *        	The value if $key is a string
	 * @return void
	 */
	 ...
	 *
	 * @param string $key
	 *        	The key for the requested key/value pair
	 * @return mixed
	 */
	 ...
	 *        	An array of context strings. Use 'all' to match all contexts.
	 * @return void
	 */
	 ...
	 *        	A context string (default is empty string for
	 ...
	 *
	 * @param bool $state
	 *        	Selected state (default is true)
	 * @return void
	 */
	 ...
	 *
	 * @param mixed $class
	 *        	An array of class names, or a single string class name.
	 * @return void
	 */
	public function setLinkClass($class) {
		if (! is_array ( $class )) {
			$this->data ['linkClass'] = array (
					$class 
			);
		} else {
	 ...
	 *
	 * @param array $current
	 *        	The current array of classes
	 * @param mixed $additional
	 *        	Additional classes (either array of string)
	 * @return void
	 */
	 ...
	 *
	 * @param int $priority
	 *        	The smaller numbers mean higher priority (1 before 100)
	 * @return void
	 ...
	 *
	 * @param string $name
	 *        	The identifier of the parent \ElggMenuItem
	 * @return void
	 */
	 ...
	 *        	A function that is passed to usort()
	 * @return void
	 * @access private
	 */
