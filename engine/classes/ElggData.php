 ...
 */
abstract class ElggData implements Loggable, // Can events related to this object class be logged
...
Exportable // (deprecated 1.9)
{
	 ...
	 *
	 * @param bool $pre18_api
	 *        	Compatibility for subclassing in 1.7 -> 1.8 change.
