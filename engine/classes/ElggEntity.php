 ...
 */
abstract class ElggEntity extends \ElggData implements Notable, // Calendar interface (deprecated 1.9)
...
Importable // Allow import of data (deprecated 1.9)
{
	 ...
	 *
	 * @param string $name
	 *        	Name of the attribute or metadata
	 * @param mixed $value
	 *        	The value to be set
	 * @return void
	 ...
	 *        	The title or name of this entity.
	 * @return void
	 */
	...
	public function getMetadata($name) {
		...
		if ($cache->isKnown ( $guid, $name )) {
			...
			$cache->populateFromEntities ( array (
					$guid 
			) );
	 ...
	 *
	 * @param string $name
	 *        	The name of the attribute or metadata.
	 *        	
	 * @return void
	 ...
	 * @param mixed $value
	 *        	Value of the metadata (doesn't support assoc arrays)
	 * @param string $value_type
	 *        	'text', 'integer', or '' for automatic detection
	 * @param bool $multiple
	 *        	Allow multiple values for a single name.
	 *        	Does not support associative arrays.
	 * @param int $owner_guid
	 *        	GUID of entity that owns the metadata.
	 *        	Default is owner of entity.
	 * @param int $access_id
	 *        	Who can read the metadata relative to the owner.
	...
	public function setMetadata($name, $value, $value_type = '', $multiple = false, $owner_guid = 0, $access_id = null) {
		...
		if ($this->guid) {
			...
			foreach ( $value as $value_tmp ) {
				...
				$md_id = create_metadata ( $this->getGUID (), $name, $value_tmp, $value_type, $owner_guid, $access_id, true );
				if (! $md_id) {
					return false;
				}
			}
	 ...
	 *
	 * @param null|string $name
	 *        	The name of metadata to delete.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *
	 * @param string $name
	 *        	The name of the metadata to clear
	 * @return mixed bool
	 ...
	 *
	 * @param string $name
	 *        	An options name of metadata to disable.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *
	 * @param string $name
	 *        	An options name of metadata to enable.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *        	The name of the relationship to remove.
	 * @return bool
	 ...
	 *
	 * @param int $guid_two
	 *        	GUID of the target entity of the relationship.
	 ...
	 *
	 * @param string $name
	 *        	Name of private setting
	 * @param mixed $value
	 *        	Value of private setting
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param null|string $name
	 *        	The annotations name to remove.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *
	 * @param null|string $name
	 *        	The name of annotations to delete.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *
	 * @param string $name
	 *        	An options name of annotations to disable.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *
	 * @param string $name
	 *        	An options name of annotations to enable.
	 * @return bool
	 * @since 1.8
	 */
	 ...
	 *        	A valid MySQL function to run its values through
	 * @return mixed
	 */
	 ...
	 *
	 * @param array $options
	 *        	Array of options for elgg_get_annotations() except guid. This
	 ...
	 *        	Offset (deprecated)
	 * @param string $order
	 *        	Order by time: asc or desc (deprecated)
	 *        	
	 * @return array
	 ...
	 *
	 * @param array $options
	 *        	Options array. See elgg_get_entities_from_relationship()
	 *        	for a list of options. 'relationship_guid' is set to
	 *        	this entity.
	 * @param bool $inverse
	 *        	Is this an inverse relationship? (deprecated)
	 * @param int $limit
	 *        	Number of elements to return (deprecated)
	 * @param int $offset
	 *        	Indexing offset (deprecated)
	 *        	
	 ...
	 *
	 * @param int $user_guid
	 *        	The user GUID, optionally (default: logged in user)
	 *        	
	 ...
	 *        	The piece of metadata to specifically check or null for any metadata
	 * @param int $user_guid
	 *        	The user GUID, optionally (default: logged in user)
	 *        	
	 * @return bool
	 ...
	 *
	 * @param int $user_guid
	 *        	The GUID of the user creating the entity (0 for logged in user).
	 * @param string $type
	 *        	The type of entity we're looking to write
	 * @param string $subtype
	 *        	The subtype of the entity we're looking to write
	 *        	
	 * @return bool
	 * @see elgg_set_ignore_access()
	 */
	 ...
	 *
	 * @param int $user_guid
	 *        	User guid (default is logged in user)
	 *        	
	 * @return bool
	 */
	 ...
	 *        	The name of the annotation (default is unspecified)
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param string $size
	 *        	Size of the icon: tiny, small, medium, large
	 *        	
	 * @return string The URL
	 * @since 1.8.0
	 */
	 ...
	 *
	 * @param string $size
	 *        	Either 'large', 'medium', 'small' or 'tiny'
	 *        	
	 ...
	 *
	 * @param \ElggSite $site
	 *        	The site to add this entity to
	 *        	
	 * @return bool
	 ...
	 *
	 * @param \ElggSite $site
	 *        	The site to remove this entity from
	 *        	
	 * @return bool
	 * @todo add \ElggSite type hint once we have removed addToSite() from \ElggUser
	 */
	 ...
	 *
	 * @param array $options
	 *        	Options array for elgg_get_entities_from_relationship()
	 ...
	 *
	 * @param mixed $guid
	 *        	GUID of entity or \stdClass object from entities table
	 *        	
	 * @return bool
	 */
	 ...
	 *        	Recursively disable all contained entities?
	 *        	
	 * @return bool
	...
	public function delete($recursive = true) {
		...
		if ($recursive) {
			...
			$options = array (
					'wheres' => array (
							"((container_guid = $guid OR owner_guid = $guid OR site_guid = $guid)" . " AND guid != $guid)" 
					),
					'limit' => 0 
			);
	 ...
	 *        	Object representation of the entity
	 * @return \stdClass
	 */
	 ...
	 *        	If ommitted, now is assumed.
	 * @param int $duration
	 *        	Duration of event, remainder of the day is assumed.
	 *        	
	 * @return true
	 * @deprecated 1.9
	 */
	...
	public function export() {
		...
		$view = elgg_view_entity ( $this, array (
				'full_view' => true 
		) );
		elgg_set_viewtype ();
	 ...
	 *        	Optionally restrict by tag metadata names.
	 *        	
	 * @return array
	 */
