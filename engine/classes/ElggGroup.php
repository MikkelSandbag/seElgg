 ...
 */
class ElggGroup extends \ElggEntity implements Friendable {
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database row result. Default is null to create a new group.
	 *        	
	 ...
	 *        	The GUID of the user joining the group.
	 *        	
	 * @return bool
	 ...
	 *
	 * @param array $options
	 *        	Options array. See elgg_get_entities_from_relationships
	 ...
	 *
	 * @param string $mode
	 *        	One of CONTENT_ACCESS_MODE_* constants
	 * @return void
	 * @access private
	 * @since 1.9.0
	 */
	 ...
	 *
	 * @param \ElggUser $user
	 *        	The user. Default is logged in user.
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param mixed $guid
	 *        	GUID of an \ElggGroup entity or database row from entity table
	 *        	
	 * @return bool
	 */
