...
class ElggUser extends \ElggEntity implements Friendable {
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database row result. Default is null to create a new user.
	 *        	
	 ...
	 *
	 * @param mixed $guid
	 *        	\ElggUser GUID or \stdClass database row from entity table
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param array $options
	 *        	Options array. Used to be $subtype
	 * @param int $limit
	 *        	The number of results to return (deprecated)
	 * @param int $offset
	 *        	Any indexing offset (deprecated)
	 *        	
	 * @return array
	 */
	 ...
	 *
	 * @param \ElggSite $site
	 *        	The site to add this user to. This used to be the
	 ...
	 *
	 * @param \ElggSite $site
	 *        	The site to remove the user from. Used to be site GUID
	 *        	
	 * @return bool
	 */
	 ...
	 * @param bool $create_river_item
	 *        	Create the river item announcing this friendship
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param int $friend_guid
	 *        	The GUID of the user to remove
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param int $user_guid
	 *        	The GUID of the user to check against
	 *        	
	 * @return bool
	 */
	 ...
	 * @param int $limit
	 *        	The number of users to retrieve (deprecated)
	 * @param int $offset
	 *        	Indexing offset, if any (deprecated)
	 *        	
	 ...
	 *        	Optionally, the user subtype (leave blank for all)
	 * @param int $limit
	 *        	The number of users to retrieve
	 * @param array $vars
	 *        	Display variables for the user view
	 *        	
	 ...
	 *
	 * @param array $options
	 *        	Options array. Used to be the subtype string.
	 * @param int $limit
	 *        	The number of groups to retrieve (deprecated)
	 * @param int $offset
	 *        	Indexing offset, if any (deprecated)
	 *        	
	 ...
	 *
	 * @param array $options
	 *        	Options array. See elgg_get_entities() for a list of options.
	 *        	'type' is set to object and owner_guid to this entity.
	 * @param int $limit
	 *        	Number of results to return (deprecated)
	 * @param int $offset
	 *        	Any indexing offset (deprecated)
	 *        	
	 * @return array|false
	 ...
	 *
	 * @param string $subtype
	 *        	The subtypes of the objects, if any
	 *        	
	 ...
	 *
	 * @param string $subtype
	 *        	Optionally, the subtype of result we want to limit to
	 * @param int $limit
