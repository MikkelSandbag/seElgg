...
class Database {
	 ...
	 * Constructor
	 *
	 * @param \Elgg\Database\Config $config
	 ...
	 *        	The type of database connection. Used to identify the
	 ...
	 *
	 * @param mixed $query
	 *        	The query being passed.
	 * @param string $callback
	 *        	Optionally, the name of a function to call back to on each row
	 *        	
	 ...
	 * @param string $query
	 *        	The query to run.
	 * @param bool $getNumRows
	 *        	Return the number of rows affected (default: false)
	 *        	
	 * @return bool|int
	 * @throws \DatabaseException
	 */
	 ...
	 *        	The callable value to fingerprint
	 *        	
	 ...
	 * @param string $callback
	 *        	An optional callback function to run on each row
	 * @param bool $single
