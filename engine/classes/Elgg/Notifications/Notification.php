...
class Notification {
	...
	/**
	 * @var string The subject of the notification.
	 * Email subject is one use.
	 */
	public $subject;
	
	/**
	 * @var string The body of the notification.
	 * Email body is one use.
	 */
	public $body;
	 ...
	 *        	The entity sending the notification (usually the site)
	 * @param \ElggEntity $to
	 *        	The entity receiving the notification
	 * @param string $language
	 *        	The language code for the notification
	 * @param string $subject
	 *        	The subject of the notification
	 * @param string $body
	 *        	The body of the notification
	 * @param string $summary
	 *        	Optional summary of the notification
	 * @param array $params
