...
class Logger {
	 ...
	 *        	The data to log
	 * @param bool $display
	 *        	Whether to include this in the HTML page
	 * @return void
	 */
	 ...
	 *        	The data to process
	 * @param bool $display
	 *        	Whether to display the data to the user. Otherwise log it.
	 * @param int $level
	 *        	The logging level for this data
	 * @return void
	 */
