...
final class Filesystem {
	 ...
	 *
	 * @param Gaufrette $gaufrette
	 *        	The underlying filesystem implementation.
	 * @param string $localPath
	 *        	Only applicable for local filesystem.
	 * @param string $chroot
	 *        	Path relative to the gaufrette filesystem's root.
	 */
	 ...
	 *
	 * @param string $path
	 *        	The relative path within this filesystem
	 *        	
	 * @return boolean
	 */
	 ...
	 *
	 * @param string $path
	 *        	The path to the directory, relative to this filesystem.
	 *        	
	 * @return boolean
	 */
	 ...
	 *
	 * @param string $path
	 *        	The path to the file, relative to this filesystem.
	 *        	
	 * @return File
	 */
	 ...
	 *
	 * @param string $path
	 *        	The filesyste-relative path to the target file.
	 *        	
	 ...
	 *
	 * @param string $path
	 *        	The directory path on this filesystem
	 *        	
	 * @return File[]
	 */
	 ...
	 *
	 * @param string $path
	 *        	The path relative to this filesystem.
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param string $path
	 *        	A file/directory path within this filesystem.
	 *        	
	 * @return string
	 */
	 ...
	 *
	 * @param string $path
	 *        	Filesystem-relative path for the file to include.
	 *        	
	 * @return mixed
	 */
	 ...
	 *
	 * @param string $path
	 *        	Filesystem-relative path to check for existence.
	 *        	
	 * @return boolean
	 */
	 ...
	 *        	The literal text content of the file.
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param string $path
	 *        	The path relative to this filesystem to chroot to.
	 *        	
	 ...
	 *
	 * @param string $path
	 *        	A relative path within this filesystem
	 *        	
	 * @return string
	 */
