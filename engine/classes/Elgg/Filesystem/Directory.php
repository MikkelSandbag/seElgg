...
interface Directory {
	 ...
	 *
	 * @param string $path
	 *        	The path relative to this directory to chroot to.
	 *        	
	 ...
	 *
	 * @param string $path
	 *        	The directory-relative path to the target file.
	 *        	
	 ...
	 *
	 * @param string $path
	 *        	The subdirectory path within this directory
	 *        	
	 ...
	 *
	 * @param string $path
	 *        	The relative path within this directory
	 *        	
	 * @return boolean
	 */
