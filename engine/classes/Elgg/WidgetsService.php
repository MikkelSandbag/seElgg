...
class WidgetsService {
	...
	public function validateType($handler) {
		if (! empty ( $this->widgets ) && ! empty ( $this->widgets->handlers ) && is_array ( $this->widgets->handlers ) && array_key_exists ( $handler, $this->widgets->handlers )) {
	...
	public function getAllTypes() {
		if (empty ( $this->widgets ) || empty ( $this->widgets->handlers ) || ! is_array ( $this->widgets->handlers )) {
			// no widgets
			return array ();
		}
