...
class UpgradeService {
	 ...
	 * @param bool $quiet
	 *        	Suppress errors. Don't use this.
	 *        	
	 * @return bool
	 */
	 ...
	 *        	Filename of the processed upgrade
	 ...
	 *        	The upgrade filename. No full path.
	 * @return int|false
	 * @since 1.8.0
	 */
	 ...
	 *
	 * @param null|array $upgrade_files
	 *        	Optional upgrade files
	 * @param null|array $processed_upgrades
	 *        	Optional processed upgrades
	 *        	
	 * @return array
	 */
	 ...
	 *
	 * @param int $version
	 *        	The version you are upgrading from in the format YYYYMMDDII.
	 * @param string $fromdir
	 *        	Optional directory to load upgrades from. default: engine/schema/upgrades/
	 * @param bool $quiet
	 *        	If true, suppress all error messages. Only use for the upgrade from <=1.6.
	 *        	
