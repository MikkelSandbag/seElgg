...
class AttributeLoader {
	 ...
	 *        	entity type this is being used to populate
	 * @param array $initialized_attrs
	 *        	attributes after initializeAttributes() has been run
	 ...
	 *
	 * @param mixed $row
	 *        	a row loaded from DB (array or \stdClass) or a GUID
