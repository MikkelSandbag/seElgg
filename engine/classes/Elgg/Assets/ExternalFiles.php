...
class ExternalFiles {
	 ...
	 *        	Predefined configuration in format used by global $CONFIG variable
	 */
	...
	public function getLoadedFiles($type, $location) {
		if (isset ( $this->CONFIG->externals ) && isset ( $this->CONFIG->externals [$type] ) && $this->CONFIG->externals [$type] instanceof \ElggPriorityList) {
	 ...
	 *
	 * @param string $type
	 *        	The type of external, js or css.
	 * @return null
	 */
