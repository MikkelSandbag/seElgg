...
final class PasswordService {
	 ...
	 *
	 * @param \ElggUser $user
	 *        	The user this is being generated for.
	 * @param string $password
	 *        	Password in clear text
	 *        	
	 * @return string
	...
	function sendNewPasswordRequest($user_guid) {
		...
		$message = _elgg_services ()->translator->translate ( 'email:changereq:body', array (
				$user->name,
				$ip_address,
				$link 
		), $user->language );
	 ...
	 *
	 * @param \ElggUser|int $user
	 *        	The user GUID or entity
	 * @param string $password
	...
	function executeNewPasswordReset($user_guid, $conf_code, $password = null) {
		...
		$message = _elgg_services ()->translator->translate ( "email:$ns:body", array (
				$user->username,
				$password 
		), $user->language );
