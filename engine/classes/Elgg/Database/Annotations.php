...
class Annotations {
	 ...
	 *
	 * @param int $id
	 *        	The id of the annotation object being retrieved.
	 *        	
	 ...
	 *        	GUID of entity to be annotated
	 * @param string $name
	 *        	Name of annotation
	 * @param string $value
	 *        	Value of annotation
	 * @param string $value_type
	 *        	Type of value (default is auto detection)
	 * @param int $owner_guid
	 *        	Owner of annotation (default is logged in user)
	 * @param int $access_id
	 *        	Access level of annotation
	 *        	
	 ...
	 *
	 * @param array $options
	 *        	An options array. {@link elgg_get_annotations()}
	 ...
	 * Also accepts all options available
	...
	function exists($entity_guid, $annotation_type, $owner_guid = null) {
		...
		$sql = "SELECT a.id FROM {$this->CONFIG->dbprefix}annotations a" . " JOIN {$this->CONFIG->dbprefix}metastrings m ON a.name_id = m.id" . " WHERE a.owner_guid = $owner_guid AND a.entity_guid = $entity_guid" . " AND m.string = '$annotation_type'";
