...
class MetadataTable {
	 ...
	 * @param Events $events
	 *        	The events registry
	 * @param MetastringsTable $metastringsTable
	 *        	The metastrings table
	 * @param Session $session
	 *        	The session
	 */
	public function __construct(Cache $cache, Database $db, EntityTable $entityTable, Events $events, MetastringsTable $metastringsTable, Session $session) {
		$this->cache = $cache;
		$this->db = $db;
