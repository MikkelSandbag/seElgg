...
class PersistentLoginService {
	 ...
	 * @param Database $db
	 *        	The DB service
	 * @param \ElggSession $session
	 *        	The Elgg session
	 * @param \ElggCrypto $crypto
	 *        	The cryptography service
	 * @param array $cookie_config
	 *        	The persistent login cookie settings
	 * @param string $cookie_token
	 *        	The token from the request cookie
	 * @param int $time
	 *        	The current time
	 */
	 ...
	 *
	 * @param \ElggUser $subject
	 *        	The user whose password changed
	 * @param \ElggUser $modifier
	 ...
	 *
	 * @param \ElggUser $user
	 *        	The user for whom we're storing the hash
	 * @param string $hash
	 *        	The hashed token
	 *        	
	 * @return void
	 ...
	 *
	 * @param string $hash
	 *        	The hashed token to remove (unused before 1.9)
	 * @return void
	 */
	 ...
	 *        	The value to return if the table doesn't exist yet
	 *        	
	 * @return mixed
	 *
	 ...
	 *
	 * @param \ElggUser $user
	 *        	The user for whom we're removing hashes
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param string $token
	 *        	The token to store in session. Empty string to remove.
	 *        	
	 * @return void
	 */
