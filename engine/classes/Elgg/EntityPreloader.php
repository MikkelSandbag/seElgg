...
class EntityPreloader {
	 ...
	 *
	 * @param array $guid_properties
	 *        	e.g. array("owner_guid")
	 */
	 ...
	 *        	Objects--e.g. loaded from an Elgg query--from which we can pluck GUIDs to preload
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param object[] $objects
	 *        	Objects from which to pluck GUIDs
	 * @return int[]
	 */
