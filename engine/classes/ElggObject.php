...
class ElggObject extends \ElggEntity {
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database row result. Default is null to create a new object.
	 *        	
	 ...
	 *
	 * @param mixed $guid
	 *        	GUID of an \ElggObject or the \stdClass object from entities table
	 *        	
	 * @return bool
	 ...
	 *
	 * @param \ElggSite $site
	 *        	The site to add this object to. This used to be the
