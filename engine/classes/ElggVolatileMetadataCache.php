...
class ElggVolatileMetadataCache {
	 ...
	 *        	The metadata value. null means it is
	 *        	known that there is no fetch-able
	 *        	metadata under this name
	 * @param bool $allow_multiple
	 *        	Can the metadata be an array
	 * @return void
	 */
	 ...
	 * We don't want to try to guess what the
	 ...
	 *
	 * @param bool $ignore
	 *        	Whether to ignore access or not
	 * @return void
	 */
	...
	public function populateFromEntities($guids) {
		...
		$options = array (
				...
				'wheres' => array (
						_elgg_get_access_where_sql ( array (
								'table_alias' => 'n_table' 
						) ) 
				) 
		);
	 ...
	 * exceed a threshold in characters.
	 * This could be used to avoid overpopulating the
	 * cache if RAM usage becomes an issue.
	 *
	 * @param array $guids
	 *        	GUIDs of entities to examine
	 * @param int $limit
	 *        	Limit in characters of all metadata (with ints casted to strings)
	 * @return array
	 */
