...
interface Friendable {
	 ...
	 *
	 * @param int $user_guid
	 *        	The GUID of the entity this entity may or may not be friends with
	 *        	
	 * @return bool
	 */
	 ...
	 *
	 * @param int $user_guid
	 *        	The GUID of the foreign entity
	 *        	
	 * @return bool
	 */
	 ...
	 *        	The subtype of entity to return
	 * @param int $limit
	 ...
	 *
	 * @param string $subtype
	 *        	The subtype of entity to count
	 *        	
	 * @return int
	 */
