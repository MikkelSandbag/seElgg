...
class ElggDiskFilestore extends \ElggFilestore {
	 ...
	 * @param int $offset
	 *        	The number of bytes to start after
	 *        	
	 ...
	 *
	 * @param string $prefix
	 *        	The prefix to check under.
	 * @param string $container_guid
	 *        	The guid of the entity whose data you want to check.
	 *        	
	 * @return int|false
	 */
	 ...
	 *        	Set parameters to save to DB for this filestore.
	 *        	
	 * @return bool
	 */
	 ...
	 *        	The guid of the entity to store the data under.
	 *        	
	 ...
	 *
	 * @param int $guid
	 *        	The entity to contrust a matrix for
	 *        	
