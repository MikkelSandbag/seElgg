...
class ElggSite extends \ElggEntity {
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database row result. Default is null to create a new site.
	 *        	
	 ...
	 *
	 * @param mixed $guid
	 *        	GUID of \ElggSite entity or database row object
	 *        	
	 * @return bool
