 ...
 */
class ElggRelationship extends \ElggData implements Importable // deprecated
{
	 ...
	 *
	 * @param \stdClass $row
	 *        	Database row or null for new relationship
	...
	/**
	 * Return a subtype.
	 * For metadata & annotations this is the 'name' and for relationship this
