...
class ElggCoreGetEntitiesFromAnnotationsTest extends \ElggCoreGetEntitiesBaseTest {
	...
	public function testElggApiGettersEntitiesFromAnnotation() {
		...
		$subtypes = $this->getRandomValidSubtypes ( array (
				'object' 
		), 1 );
		$subtype = $subtypes [0];
