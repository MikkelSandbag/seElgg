...
class ElggCoreHelpersTest extends \ElggCoreUnitTest {
	...
	public function testHttpUrlIsIdenticalIgnoreParamsHandling() {
		$tests = array (
				array (
						'page/handler',
						elgg_get_site_url () . 'page/handler',
						array (
								'p',
								'p2' 
						),
				...
				array (
						'page/handler?p=v&p2=q2',
						elgg_get_site_url () . 'page/handler?p=q&p2=v2',
						array (
								'p',
								'p2' 
						),
				...
				array (
						'/rootfile.php',
						elgg_get_site_url () . 'rootfile.php?param=23',
						array (
								'param' 
						),
						true 
				...
				array (
						'/rootfile.php?p=v&p2=v2',
						elgg_get_site_url () . 'rootfile.php?p=v&p2=q',
						array (
								'p',
								'p2' 
						),
				...
				array (
						'mod/plugin/file.php?other_param=123',
						elgg_get_site_url () . 'mod/plugin/file.php',
						array (
								'q',
								'p2' 
						),
	...
	public function testElggGetFriendlyTime() {
		...
		$offsets = array (
				...
				'-120' => elgg_echo ( 'friendlytime:minutes', array (
						'2' 
				) ),
				'-60' => elgg_echo ( 'friendlytime:minutes:singular' ),
				'-10800' => elgg_echo ( 'friendlytime:hours', array (
						'3' 
				) ),
				'-86400' => elgg_echo ( 'friendlytime:days:singular' ),
				'120' => elgg_echo ( 'friendlytime:future:minutes', array (
						'2' 
				) ),
