...
class ElggCoreUrlHelpersTest extends \PHPUnit_Framework_TestCase {
	...
	public function testElggHttpAddURLQueryElementsPreserveURL() {
		$tests = array (
				...
				array (
						'https://example.com/path?foo=123&bar=abc',
						array (),
						'https://example.com/path?foo=123&bar=abc' 
				) 
		);
	...
	public function testElggHttpAddURLQueryElementsAddElements() {
		$tests = array (
				...
				array (
						...
						'http://example-time.com/path?foo=bar' 
				),
				...
				array (
						...
						'https://example.com?foo=123&bar=abc&foo2=bar2' 
				),
				array (
						'https://example.com/path?foo=123&bar=abc',
						array (
						...
						'https://example.com/path?foo=bar&bar=abc' 
				),
				array (
						'https://example.com?foo=123&bar=abc',
						array (
						...
						'https://example.com?foo=123&bar=abc&foo2=bar2&123=456' 
				),
				array (
						'https://example.com/path?foo=123&bar=abc',
						array (
	...
	public function testElggHttpAddURLQueryElementsRemoveElements() {
		$tests = array (
				...
				array (
						...
						'https://example.com?bar=abc&foo2=bar2' 
				),
				array (
						'https://example.com/path?bar=abc&foo=123',
						array (
								'foo' => null,
								'foo2' => 'bar' 
						),
						'https://example.com/path?bar=abc&foo2=bar' 
				),
				array (
						'https://example.com?foo=123&bar=abc',
						array (
						...
						'https://example.com?bar=abc&foo2=bar2&123=456' 
				),
				array (
						'https://example.com/path?foo=123&bar=abc',
						array (
