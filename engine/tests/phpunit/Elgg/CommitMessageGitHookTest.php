...
class CommitMessageGitHookTest extends \PHPUnit_Framework_TestCase {
	 ...
	 * @param string $output
	 *        	Output from stdout and stderr will be written to this variable
	 * @param array $env
	 *        	Array of environment variables to be passed to sub-process
...
;
		$defaultEnv = array (
				'PATH' => getenv ( 'PATH' ) 
		) // we need to copy PATH variable to run php without specifying absolute path
;
